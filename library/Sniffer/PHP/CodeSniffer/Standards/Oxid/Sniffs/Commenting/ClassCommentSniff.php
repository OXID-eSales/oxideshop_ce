...
if (class_exists('Oxid_Sniffs_Commenting_FileCommentSniff', true) === false) {
    $error = 'Class Oxid_Sniffs_Commenting_FileCommentSniff not found';
    throw new PHP_CodeSniffer_Exception($error);
}
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Oxid_Sniffs_Commenting_ClassCommentSniff extends Oxid_Sniffs_Commenting_FileCommentSniff
{
