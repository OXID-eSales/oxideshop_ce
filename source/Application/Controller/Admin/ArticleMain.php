...
class ArticleMain extends \OxidEsales\Eshop\Application\Controller\Admin\AdminDetailsController
{
    ...
    public function render()
    {
        ...
        // new variant ?
        if (isset($sVoxId) && '-1' === $sVoxId && isset($sOxParentId) && $sOxParentId && '-1' !== $sOxParentId) {
    ...
    public function save(): void
    {
        ...
        if (isset($soxparentId) && $soxparentId && '-1' !== $soxparentId) {
     ...
     */
    // phpcs:ignore PSR2.Methods.MethodDeclaration.Underscore
    protected function _resetCategoriesCounter($sArticleId): void
    {
        $oDb = DatabaseProvider::getDb();
     ...
     */
    public function addToCategory($sCatID, $sOXID): void
    {
     ...
     */
    public function copyArticle($sOldId = null, $sNewId = null, $sParentId = null): void
    {
        $myConfig = \OxidEsales\Eshop\Core\Registry::getConfig();

        $sOldId = $sOldId ?: $this->getEditObjectId();
        $sNewId = $sNewId ?: \OxidEsales\Eshop\Core\Registry::getUtilsObject()->generateUID();
        ...
        if ($oArticle->load($sOldId)) {
            ...
            if (!$sParentId) {
                ...
                if (
                    ...
                    $oArticle->$sArtNumField->value && 'copyArticle' === $sFncParameter
                ) {
     ...
     */
    // phpcs:ignore PSR2.Methods.MethodDeclaration.Underscore
    protected function _copyCategories($sOldId, $newArticleId): void
    {
        $myUtilsObject = \OxidEsales\Eshop\Core\Registry::getUtilsObject();
        $oDb = DatabaseProvider::getDb();
     ...
     */
    // phpcs:ignore PSR2.Methods.MethodDeclaration.Underscore
    protected function _copyAttributes($sOldId, $sNewId): void
    {
        $myUtilsObject = \OxidEsales\Eshop\Core\Registry::getUtilsObject();
        $oDb = DatabaseProvider::getDb();
     ...
     */
    // phpcs:ignore PSR2.Methods.MethodDeclaration.Underscore
    protected function _copyFiles($sOldId, $sNewId): void
    {
        $myUtilsObject = \OxidEsales\Eshop\Core\Registry::getUtilsObject();
     ...
     */
    // phpcs:ignore PSR2.Methods.MethodDeclaration.Underscore
    protected function _copySelectlists($sOldId, $sNewId): void
    {
        $myUtilsObject = \OxidEsales\Eshop\Core\Registry::getUtilsObject();
        $oDb = DatabaseProvider::getDb();
     ...
     */
    // phpcs:ignore PSR2.Methods.MethodDeclaration.Underscore
    protected function _copyCrossseling($sOldId, $sNewId): void
    {
        $myUtilsObject = \OxidEsales\Eshop\Core\Registry::getUtilsObject();
        $oDb = DatabaseProvider::getDb();
     ...
     */
    // phpcs:ignore PSR2.Methods.MethodDeclaration.Underscore
    protected function _copyAccessoires($sOldId, $sNewId): void
    {
        $myUtilsObject = \OxidEsales\Eshop\Core\Registry::getUtilsObject();
        $oDb = DatabaseProvider::getDb();
     ...
     */
    // phpcs:ignore PSR2.Methods.MethodDeclaration.Underscore
    protected function _copyStaffelpreis($sOldId, $sNewId): void
    {
     ...
     */
    // phpcs:ignore PSR2.Methods.MethodDeclaration.Underscore
    protected function _copyArtExtends($sOldId, $sNewId): void
    {
     ...
     */
    // phpcs:ignore PSR2.Methods.MethodDeclaration.Underscore
    protected function _formJumpList($oArticle, $oParentArticle): void
    {
        $aJumpList = [];
    ...
    {
        return oxNew(\OxidEsales\Eshop\Application\Model\Article::class);
    }
}
