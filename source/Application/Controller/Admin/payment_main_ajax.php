...
class payment_main_ajax extends ajaxListComponent
{
    ...
    protected function _getQuery()
    {
        ...
        $sGroupId = $this->config->getRequestParameter('oxid');
        $sSynchGroupId = $this->config->getRequestParameter('synchoxid');
        $oDb = oxDb::getDb();
        ...
        if (!$sSynchGroupId) {
            $sSynchGroupId = $this->config->getRequestParameter('oxajax_synchfid');
        }
