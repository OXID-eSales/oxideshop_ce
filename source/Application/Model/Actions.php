...
class Actions extends \OxidEsales\Eshop\Core\Model\MultiLanguageModel
{
    ...
    public function start(): void
    {
        ...
        if ($this->oxactions__oxactiveto->value && ('0000-00-00 00:00:00' !== $this->oxactions__oxactiveto->value)) {
            $iNow = \OxidEsales\Eshop\Core\Registry::getUtilsDate()->getTime();
    ...
    public function isRunning()
    {
        if (
            ...
            $this->oxactions__oxactive->value
              && 2 === $this->oxactions__oxtype->value
              && '0000-00-00 00:00:00' !== $this->oxactions__oxactivefrom->value
            )
        ) {
            return false;
        }
        ...
        if ('0000-00-00 00:00:00' !== $this->oxactions__oxactiveto->value) {
            $iTo = strtotime($this->oxactions__oxactiveto->value);
            if ($iNow > $iTo) {
                return false;
            }
