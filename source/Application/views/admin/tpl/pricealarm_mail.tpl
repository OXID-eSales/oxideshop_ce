...
<br><br>
[{if $iAllCnt && !$readonly}]
[{oxmultilang ident="PRICEALARM_MAIL_SENDPRICEALARMEMAIL1"}] <a href="[{$oViewConf->getSelfLink() nofilter}]&cl=pricealarm_send" class="edittext" target="list" [{if $readonly}]onclick="JavaScript:return false;"[{/if}]><b>[{oxmultilang ident="PRICEALARM_MAIL_SENDPRICEALARMEMAIL2"}]</b></a>
[{/if}]
