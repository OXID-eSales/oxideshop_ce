...
class Email extends PHPMailer
{
    ...
    public function __call($method, $args)
    {
        ...
        throw new SystemComponentException("Function '$method' does not exist or is not accessible! (" . static::class . ')' . PHP_EOL);
    }
    ...
    public function setSmtp($shop = null): void
    {
        ...
        if (6 === $myConfig->getConfigParam('iDebug')) {
    ...
    protected function _isValidSmtpHost($smtpHost) // phpcs:ignore PSR2.Methods.MethodDeclaration.Underscore
    {
        ...
        if ($smtpHost) {
            ...
            if (Str::getStr()->preg_match('@^(.*?)(:([0-9]+))?$@i', $smtpHost, $match)) {
                $smtpHost = $match[1];
                if (isset($match[3]) && 0 !== (int)$match[3]) {
    ...
    public function sendOrderEmailToOwner($order, $subject = null)
    {
        ...
        if ('admin' !== $user->oxuser__oxusername->value) {
            $fullName = $user->oxuser__oxfname->getRawValue() . ' ' . $user->oxuser__oxlname->getRawValue();
        ...
        if (6 === $config->getConfigParam('iDebug')) {
     ...
     */
    protected function onOrderEmailToOwnerSent($user, $order): void
    {
        // add user history
    ...
    public function sendRegisterEmail($user, $subject = null)
    {
        ...
        $this->setSubject((null !== $subject) ? $subject : $shop->oxshops__oxregistersubject->getRawValue());
    ...
    public function sendForgotPwdEmail($emailAddress, $subject = null)
    {
        ...
        if ($oxid && $user->load($oxid)) {
            ...
            $this->setSubject((null !== $subject) ? $subject : $shop->oxshops__oxforgotpwdsubject->getRawValue());
    ...
    public function sendNewsletterDbOptInMail($user, $subject = null)
    {
        ...
        $this->setSubject((null !== $subject) ? $subject : \OxidEsales\Eshop\Core\Registry::getLang()->translateString('NEWSLETTER') . ' ' . $shop->oxshops__oxname->getRawValue());
    ...
    public function sendNewsletterMail($newsLetter, $user, $subject = null)
    {
        ...
        $this->setSubject((null !== $subject) ? $subject : $newsLetter->oxnewsletter__oxtitle->getRawValue());
    ...
    public function sendSendedNowMail($order, $subject = null)
    {
        ...
        //Sets subject to email
        $this->setSubject((null !== $subject) ? $subject : $shop->oxshops__oxsendednowsubject->getRawValue());
    ...
    public function sendDownloadLinksMail($order, $subject = null)
    {
        ...
        //Sets subject to email
        $this->setSubject((null !== $subject) ? $subject : $lang->translateString('DOWNLOAD_LINKS', null, false));
    ...
    public function sendStockReminder($basketContents, $subject = null)
    {
        ...
        if ($articleList->count()) {
            ...
            $this->setAltBody('');
            $this->setSubject((null !== $subject) ? $subject : $lang->translateString('STOCK_LOW'));
    ...
    public function sendPriceAlarmNotification($params, $alarm, $subject = null)
    {
        ...
        $this->setSubject((null !== $subject) ? $subject : $lang->translateString('PRICE_ALERT_FOR_PRODUCT', $alarmLang) . ' ' . $article->oxarticles__oxtitle->getRawValue());
     ...
     */
    protected function _includeImages($imageDir = null, $imageDirNoSSL = null, $dynImageDir = null, $absImageDir = null, $absDynImageDir = null): void // phpcs:ignore PSR2.Methods.MethodDeclaration.Underscore
    {
        $body = $this->getBody();
                ...
                foreach ($matches as $image) {
                    ...
                    if ($fileName) {
                        if (isset($imageCache[$fileName]) && $imageCache[$fileName]) {
                            ...
                            if ('image/jpeg' === $mIME || 'image/gif' === $mIME || 'image/png' === $mIME) {
     ...
     */
    protected function _clearMailer(): void // phpcs:ignore PSR2.Methods.MethodDeclaration.Underscore
    {
        $this->clearAllRecipients();
        $this->clearReplyTos();
        $this->clearAttachments();
     ...
     */
    protected function _setMailParams($shop = null): void // phpcs:ignore PSR2.Methods.MethodDeclaration.Underscore
    {
        $this->_clearMailer();
     ...
     */
    protected function _setSmtpAuthInfo($userName = null, $userPassword = null): void // phpcs:ignore PSR2.Methods.MethodDeclaration.Underscore
    {
     ...
     */
    protected function _setSmtpDebug($debug = null): void // phpcs:ignore PSR2.Methods.MethodDeclaration.Underscore
    {
     ...
     */
    protected function _makeOutputProcessing(): void // phpcs:ignore PSR2.Methods.MethodDeclaration.Underscore
    {
     ...
     */
    protected function _processViewArray(): void // phpcs:ignore PSR2.Methods.MethodDeclaration.Underscore
    {
    ...
    {
        return 0 !== Registry::getConfig()->getConfigParam('iDebug');
    }
