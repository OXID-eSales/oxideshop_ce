...
class ShopControllerMapProvider implements ControllerMapProviderInterface
{
    private $controllerMap = [
        ...
        'news_list' => Controller\Admin\NewsList::class,
        'news_main' => Controller\Admin\NewsMain::class,
        'news_main_ajax' => Controller\Admin\NewsMainAjax::class,
        'news_text' => Controller\Admin\NewsText::class,
        ...
        'admin_news' => Controller\Admin\AdminNews::class,
