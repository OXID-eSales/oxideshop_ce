...
class Utils extends \OxidEsales\Eshop\Core\Base
{
    ...
    public function redirect($sUrl, $blAddRedirectParam = true, $iHeaderCode = 302)
    {
        ...
        if ($blAddRedirectParam && $redirectCount > 3) {
            throw new RedirectException("Too many previous redirects were detected when forwarding to $sUrl. OXID eShop allows a maximum of 3 redirects to ensure a good user experience");
        }
