...
class UtilsObject
{
     ...
     */
    public function setModuleVar($variableName, $value): void
    {
     ...
     */
    public static function resetModuleVars(): void
    {
    ...
    {
        if (null === $this->classNameProvider) {
    ...
    {
        if (null === $this->moduleChainsGenerator) {
