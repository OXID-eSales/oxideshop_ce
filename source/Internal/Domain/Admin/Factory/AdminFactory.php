...
{
    public function __construct(private ShopAdapterInterface $shopAdapter, private EmailValidatorServiceInterface $emailValidatorService, private PasswordHashServiceInterface $passwordHashService)
    {
    }
