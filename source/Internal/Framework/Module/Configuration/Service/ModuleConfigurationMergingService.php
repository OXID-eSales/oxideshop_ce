...
{
    public function __construct(private SettingsMergingServiceInterface $settingsMergingService, private ModuleClassExtensionsMergingServiceInterface $classExtensionsMergingService)
    {
    }
