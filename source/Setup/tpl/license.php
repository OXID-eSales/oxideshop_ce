...
require "_header.php"; ?>
    ...
    <form action="index.php" method="post">
        ...
        <label><input type="radio" name="iEula" value="1"><?php $this->getText('BUTTON_RADIO_LICENCE_ACCEPT'); ?></label><br>
        <label><input type="radio" name="iEula" value="0" checked><?php $this->getText('BUTTON_RADIO_LICENCE_NOT_ACCEPT'); ?></label><br><br>
