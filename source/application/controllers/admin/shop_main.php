...
class Shop_Main extends oxAdminDetails
{
    ...
    {
        $aNonCopyVars = array("aSerials", "IMS", "IMD", "IMA", "sUtilModule", "aModulePaths", "aModuleFiles", "aModuleEvents", "aModuleVersions", "aModuleTemplates", "aModules", "aDisabledModules");
