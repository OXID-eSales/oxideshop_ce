...
class oxArticle extends oxI18n implements oxIArticle, oxIUrl
{
     ...
     * @param string $sOxId
     */
    public function resetStaticCache( $sOxId = null )
    {
        if ( !is_null( $sOxId ) ) {
            unset( self::$_aArticleData[$sOxId] );
        } else {
    ...
    public function onChange($sAction = null, $sOXID = null, $sParentID = null)
    {
        ...
        $this->resetStaticCache( $this->getId() );
    }
    ...
    /**
     * Resets static cache of an article and loads it in different language
     *
     * @param int $iLanguage
     * @param string $sOxid
     *
    ...
    {
        $this->resetStaticCache( $sOxid );
        return parent::loadInLang( $iLanguage, $sOxid ); // TODO: Change the autogenerated stub
    }
