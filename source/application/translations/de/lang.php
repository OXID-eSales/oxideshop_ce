...
'INVALID_TAGS_REMOVED'                                        => "Unzul�ssige Tags wurden entfernt",
'ALREADY_CUSTOMER'                                            => "Ich bin bereits Kunde",
'APPLAY'                                                      => "�bernehmen",
'ARTNUM'                                                      => "Artikelnummer",
'ATENTION_GREETING_CARD'                                      => "ACHTUNG Gru�karte",
'AUTHOR'                                                      => "Autor",
'AVAILABLE_ON'                                                => "Lieferbar ab",
'BACK_TO_OVERVIEW'                                            => "Zur�ck zur �bersicht",
'BACK_TO_SHOP'                                                => "Zur�ck zum Shop",
...
'BARGAIN'                                                     => "Schn�ppchen",
'BARGAIN_PRODUCTS'                                            => "Die besten Schn�ppchen des Shops",
...
'CARD_SECURITY_CODE'                                          => "Pr�fziffer",
'CARD_SECURITY_CODE_DESCRIPTION'                              => "Diese befindet sich auf der R�ckseite Ihrer Kreditkarte. Die Pr�fziffer sind die letzten drei Ziffern im Unterschriftsfeld.",
'CARD_TO'                                                     => "Karte an",
'CARD_VISA'                                                   => "Visa",
'CART'                                                        => "Warenkorb",
'CATEGORIES'                                                  => "Kategorien",
'CATEGORY'                                                    => "Kategorie",
'CATEGORY_OVERVIEW'                                           => "Kategorie�bersicht",
'CATEGORY_PRODUCTS_S'                                         => "Kategorie/%s",
'CATEGORY_S'                                                  => "| Kategorie: %s",
'CELLUAR_PHONE'                                               => "Mobiltelefon",
'CHANGE'                                                      => "�ndern",
'CHANGE_ACCOUNT_PASSWORD'                                     => "Kontopasswort �ndern",
...
'DO_NOT_WANT_CREATE_ACCOUNT'                                  => "(Ich m�chte kein Kundenkonto er�ffnen)",
'EDIT'                                                        => "�ndern",
...
'ERROR_MESSAGE_ARTICLE_ARTICLE_DOES_NOT_EXIST'                => "Der Artikel \"%s\" ist leider nicht mehr verf�gbar",
...
'ERROR_MESSAGE_CHECK_EMAIL'                                   => "Fehler beim Versenden - bitte E-Mail-Adressen �berpr�fen.",
'ERROR_MESSAGE_CONNECTION_IPAYMENTNOCONNECTION'               => "Keine Verbindung zum IPayment Server m�glich!",
'EXCEPTION_CONNECTION_NODB'                                   => "Keine Verbindung zur Datenbank m�glich!",
'ERROR_MESSAGE_CONNECTION_NOLDAP'                             => "Keine Verbindung zum LDAP Server m�glich!",
'ERROR_MESSAGE_CONNECTION_NOLDAPBIND'                         => "Fehler bei der Kommunikation mit dem LDAP Server!",
'ERROR_MESSAGE_COOKIE_NOCOOKIE'                               => "F�r diese Aktion werden Cookies ben�tigt. Bitte aktivieren Sie Cookies oder nutzen Sie einen anderen Browser.",
'ERROR_MESSAGE_ERROR_OCCURRED'                                => "Ein OXID eShop Fehler ist aufgetreten",
'ERROR_MESSAGE_FILE_ERRORINFILE'                              => "Fehler in Datei!",
'ERROR_MESSAGE_GUESTBOOK_ENTRY_ERR_LOGIN_TO_WRITE_ENTRY'      => "Fehler: Um einen G�stebuch Eintrag zu schreiben, m�ssen sie eingeloggt sein.",
'ERROR_MESSAGE_GUESTBOOK_ENTRY_ERR_MAXIMUM_NUMBER_EXCEEDED'   => "Fehler: Flood Protection aktiv. Sie k�nnen heute keinen Eintrag mehr schreiben.",
...
'ERROR_MESSAGE_INPUT_INVALIDAMOUNT'                           => "Bitte geben Sie eine g�ltige Menge f�r den Artikel ein!",
'ERROR_MESSAGE_INPUT_NOTALLFIELDS'                            => "Bitte Wert angeben!",
'ERROR_MESSAGE_INPUT_NOVALIDEMAIL'                            => "Bitte geben Sie eine g�ltige E-Mail-Adresse ein",
'ERROR_MESSAGE_INVITE_ERRORWHILESENDINGMAIL'                  => "Es ist ein Fehler beim Versenden der E-Mails aufgetreten. Bitte �berpr�fen Sie die E-Mail-Adressen.",
'ERROR_MESSAGE_INVITE_INCORRECTEMAILADDRESS'                  => "Ung�ltige E-Mail-Adresse. Bitte �berpr�fen Sie die E-Mail-Adressen.",
'ERROR_MESSAGE_MANDATES_EXCEEDED'                             => "Die Anzahl der lizenzierten Mandanten ist �berschritten, tragen Sie bitte im Shop Admin eine g�ltige Lizenznr. ein - oder kontaktieren Sie %s f�r mehr Informationen.",
'ERROR_MESSAGE_MANDATES_EXCEEDED1'                            => "Die Anzahl der lizenzierten Mandanten ist �berschritten, tragen Sie bitte im Shop Admin eine g�ltige Lizenznr. ein - oder kontaktieren Sie",
'FOR_MORE_INFORMATION'                                        => "f�r mehr Informationen.",
...
'ERROR_MESSAGE_OUTOFSTOCK_OUTOFSTOCK'                         => "Der Lagerbestand dieses Artikels ist nicht ausreichend! Verf�gbar",
'ERROR_MESSAGE_OXID_ESALES'                                   => "OXID eSales",
'ERROR_MESSAGE_OXID_SHOP_ERROR'                               => "OXID eShop Fehler",
'ERROR_MESSAGE_PASSWORD_DO_NOT_MATCH'                         => "Fehler: Die Passw�rter stimmen nicht �berein.",
'ERROR_MESSAGE_PASSWORD_EMAIL_INVALID'                        => "Die eingegebene E-Mail-Adresse ist ung�ltig. Bitte geben Sie eine g�ltige E-Mail-Adresse ein.",
'ERROR_MESSAGE_PASSWORD_LINK_EXPIRED'                         => "Diese Seite ist nicht mehr g�ltig. Bitte benutzen Sie die Passwort vergessen Funktion erneut.",
...
'ERROR_MESSAGE_UNLICENSED1'                                   => "Ihr Shop ist nicht lizensiert, tragen Sie bitte im Shop Admin eine g�ltige Lizenznr. ein - oder kontaktieren Sie",
'ERROR_MESSAGE_USER_NOVALIDLOGIN'                             => "Falsche E-Mail oder Passwort!",
'ERROR_MESSAGE_USER_NOVALUES'                                 => "E-Mail und Passwort m�ssen ausgef�llt sein!",
'ERROR_MESSAGE_USER_PWDDONTMATCH'                             => "Passw�rter stimmen nicht �berein!",
...
'ERROR_MESSAGE_VOUCHER_INCORRECTPRICE'                        => "Einkaufswert noch zu niedrig f�r diesen Gutschein!",
...
'ERROR_MESSAGE_VOUCHER_NOVOUCHER'                             => "Gutschein ung�ltig!",
'ERROR_MESSAGE_COMPLETE_FIELDS_CORRECTLY'                     => "Felder mit einem * m�ssen ausgef�llt werden.",
...
'GIFT_WRAPPING_GREETING_CARD'                                 => "Geschenkverpackung/Gru�karte",
'GO'                                                          => "GO!",
'GRAND_TOTAL'                                                 => "Gesamtsumme",
'GREETING'                                                    => "Hallo, ",
'GREETING_CARD'                                               => "Gru�karte",
'GREETING_MESSAGE'                                            => "Gru�nachricht",
'GROSS'                                                       => "(brutto)",
'GUESTBOOK'                                                   => "Unser G�stebuch",
'HAVE_A_LOOK'                                                 => "Schau dir das mal an",
'HAVE_YOU_FORGOTTEN_PASSWORD'                                 => "Sie haben Ihr Passwort vergessen?",
'HAVE_YOU_SEEN'                                               => "Schon gesehen?",
'HELP'                                                        => "Hilfe",
'HERE_YOU_CAN_ENETER_MESSAGE'                                 => "Hier k�nnen Sie uns noch etwas mitteilen.",
'HERE_YOU_SET_UP_NEW_PASSWORD'                                => "Kein Problem, hier k�nnen Sie ein neues Passwort einrichten.",
'HIGHLIHGT_TAGS'                                              => "Existierende Tags hervorheben oder neue einf�gen",
'HITS_FOR'                                                    => "Treffer f�r",
'HOME'                                                        => "Startseite",
'IBAN'                                                        => "IBAN",
...
'LISTMANIA_LIST_FOR'                                          => "Lieblingsliste f�r %s",
'LISTMANIA_LIST_PRODUCTS'                                     => "Artikel von Lieblingsliste %s",
'LISTMANIA_LIST_SAVED'                                        => "�nderungen der Lieblingsliste wurden gespeichert",
'LISTS'                                                       => "Listen",
...
'LOGIN_TO_ACCESS_GIFT_REGISTRY'                               => "F�r Wunschzettel bitte einloggen.",
'LOGIN_TO_ACCESS_LISTMANIA'                                   => "F�r die Lieblingsliste bitte einloggen.",
'LOGIN_TO_ACCESS_WISH_LIST'                                   => "F�r Merkzettel bitte einloggen.",
'LOGIN_WITH'                                                  => "Login mit",
'LOGOUT'                                                      => "Logout",
'LOW_STOCK'                                                   => "Wenige Exemplare auf Lager - schnell bestellen!",
'MAKE_PAYMENT'                                                => "Zahlung durchf�hren",
'MANUFACTURER'                                                => "Hersteller",
'MANUFACTURER_S'                                              => "| Hersteller: %s",
'MANY_GREETINGS'                                              => "Viele Gr��e,",
'MEDIA'                                                       => "Medien",
'MESSAGE'                                                     => "Nachricht",
'MESSAGE_ACCOUNT_REGISTRATION_CONFIRMED'                      => "Der Account wurde er�ffnet.",
'MESSAGE_ALREADY_RATED'                                       => "Sie haben schon bewertet!",
'MESSAGE_BASKET_EXCLUDE_INFO'                                 => "Sie k�nnen zur Kasse gehen und ihre Bestellung abschliessen. Oder Sie k�nnen weiter einkaufen, jedoch wird dann der Warenkorbinhalt geleert.",
'MESSAGE_CONFIRMATION_NOT_SUCCEED'                            => "Leider konnten wir Ihnen keine Bestellbest�tigung per E-Mail zustellen.",
'MESSAGE_CONFIRMING_REGISTRATION'                             => "Sie haben eine E-Mail von uns erhalten, die Ihre Mitgliedschaft best�tigt.",
...
'MESSAGE_ENTER_YOUR_ADDRESS_AND_MESSAGE'                      => "Geben Sie die Adressdaten und Ihre pers�nliche Nachricht ein.",
'MESSAGE_FROM'                                                => "Nachricht von",
'MESSAGE_GET_BONUS_POINTS'                                    => "Jetzt! Holen Sie sich f�r Ihren Einkauf Bonuspunkte.",
'MESSAGE_INVALID_EMAIL'                                       => "Keine g�ltige E-Mail-Adresse!",
'MESSAGE_INVITE_YOUR_FRIENDS'                                 => "Laden Sie Ihre Freunde ein und erhalten Sie Bonuspunkte f�r jede neue Registrierung.",
...
'MESSAGE_LOGIN_TO_RATE'                                       => "F�r Bewertung bitte einloggen!",
'MESSAGE_LOGIN_TO_WRITE_REVIEW'                               => "Sie m�ssen angemeldet sein, um einen Kommentar schreiben zu k�nnen.",
'MESSAGE_MAKE_GIFT_REGISTRY_PUBLISH'                          => "Mein Wunschzettel soll von allen gesucht und angesehen werden k�nnen",
'MESSAGE_NEGATIVE_TOTAL'                                      => "Einkaufswert unter 0,- nicht erlaubt.",
'MESSAGE_NEWSLETTER_CONGRATULATIONS'                          => "Herzlichen Gl�ckwunsch!",
'MESSAGE_NEWSLETTER_FOR_SUBSCRIPTION_BONUS'                   => "Jetzt! Holen Sie sich f�r Ihr Newsletter-Abonnement Bonuspunkte.",
'MESSAGE_NEWSLETTER_SUBSCRIPTION'                             => "Sie k�nnen den Newsletter jederzeit kostenlos abbestellen.",
'MESSAGE_NEWSLETTER_SUBSCRIPTION_ACTIVATED'                   => "Sie sind nun freigeschaltet f�r den Empfang unseres Newsletters.",
...
'MESSAGE_PASSWORD_CHANGED'                                    => "Ihr Passwort wurde ge�ndert.",
'MESSAGE_PAYMENT_AUTHORIZATION_FAILED'                        => "Authorisierung der Zahlung fehlgeschlagen. Bitte pr�fen Sie Ihre Eingabe.",
'MESSAGE_PAYMENT_SELECT_ANOTHER_PAYMENT'                      => "Bitte w�hlen Sie ggf. eine andere Zahlungsart.",
'MESSAGE_PAYMENT_BANK_CODE_INVALID'                           => "Bitte geben Sie eine g�ltige Bankleitzahl an!",
'MESSAGE_PAYMENT_ACCOUNT_NUMBER_INVALID'                      => "Bitte geben Sie eine g�ltige Kontonummer an!",
'MESSAGE_PAYMENT_UNAVAILABLE_PAYMENT'                         => "Die Zahlungsweise ist aus technischen Gr�nden derzeit leider nicht m�glich. Bitte w�hlen Sie eine andere Zahlungsart.",
'MESSAGE_PAYMENT_UNAVAILABLE_PAYMENT_ERROR'                   => "Die Zahlungsweise ist aus technischen Gr�nden derzeit leider nicht m�glich. Bitte w�hlen Sie eine andere Zahlungsart. (Fehler",
'MESSAGE_PLEASE_CONTACT_SUPPORT'                              => "Bitte wenden Sie sich an den OXID eSales Support.",
'MESSAGE_PLEASE_DELETE_DIRECTORY_SET'                         => "Bitte l�schen Sie das Setupverzeichnis: %ssetup!",
'MESSAGE_PLEASE_DELETE_DIRECTORY'                             => "Bitte l�schen Sie das Setupverzeichnis",
'MESSAGE_PLEASE_DELETE_DIRECTORY_SETUP'                       => "setup!",
'MESSAGE_PLEASE_DELETE_DIRECTORY_UPDATEAPP'                   => "updateApp",
'MESSAGE_PLEASE_DELETE_FOLLOWING_DIRECTORY'                   => "Bitte l�schen Sie folgendes Verzeichnis",
'MESSAGE_PRICE_ALARM_PRICE_CHANGE'                            => "Gerne informieren wir Sie unverbindlich dar�ber, falls sich der Preis dieses Artikels �ndert bzw. Ihrem Wunschpreis entspricht.",
...
'MESSAGE_SELECT_AT_LEAST_ONE_PRODUCT'                         => "Bitte w�hlen Sie einen Artikel aus.",
'MESSAGE_SELECT_MORE_PRODUCTS'                                => "Bitte w�hlen Sie Artikel zum Vergleichen aus.",
'MESSAGE_SEND_GIFT_REGISTRY'                                  => "Klicken Sie hier, um Ihren Wunschzettel an Ihre Freunde zu versenden.",
'MESSAGE_SENT_CONFIRMATION_EMAIL'                             => "Sie haben soeben eine E-Mail erhalten, mit der Sie unseren Newsletter freischalten k�nnen.",
...
'MESSAGE_SUBMIT_BOTTOM'                                       => "Senden Sie Ihre Bestellung am unteren Ende dieser �bersicht ab",
'MESSAGE_THANKYOU_FOR_SUBSCRIBING_NEWSLETTERS'                => "Vielen Dank f�r das Abonnement unseres Newsletters.",
'MESSAGE_TO_BE_LOGGED_WRITE_GUESTBOOK'                        => "Sie m�ssen angemeldet sein, um einen G�stebucheintrag schreiben zu k�nnen.",
'MESSAGE_TRUSTED_SHOPS_SEAL_OF_APPROVAL'                      => " ist ein von Trusted Shops gepr�fter Onlineh�ndler mit G�tesiegel und K�uferschutz. Mehr...",
'MESSAGE_UNAVAILABLE_SHIPPING_METHOD'                         => "Die von Ihnen gew�hlte Versandart ist nicht mehr verf�gbar. Bitte w�hlen Sie eine andere Versandart aus.",
...
'MESSAGE_WRONG_VERIFICATION_CODE'                             => "Der Pr�fcode, den Sie eingegeben haben, ist nicht korrekt. Bitte versuchen Sie es erneut.",
'MESSAGE_YOU_RECEIVED_ORDER_CONFIRM'                          => "Sie haben bereits eine Bestellbest�tigung �ber die gew�nschten Artikel per Mail erhalten.",
'MESSAGE_DOWNLOADABLE_PRODUCT'                                => "Hinweis: Sie haben Download-Artikel im Warenkorb. Wenn Sie ohne Registrierung einkaufen, finden Sie Downloadlinks ausschlie�lich in Ihrer E-Mail zur Bestellbest�tigung. Sind Sie registriert, werden die Downloadlinks unter Mein Konto -> Meine Downloads angezeigt.",
...
'NO_GREETING_CARD'                                            => "Keine Gru�karte",
...
'NO_TAGS'                                                     => "Zurzeit keine Tags verf�gbar",
'NUMBER'                                                      => "Nummer",
'NUMBER_2'                                                    => "Nr.",
'OF'                                                          => "VON",
'OLD_PASSWORD'                                                => "Altes Passwort",
'ONLY_IN_PACKING_UNITS_OF'                                    => "Nur in Verpackungseinheiten zu je ",
'OPEN_ACCOUNT'                                                => "Konto er�ffnen",
'OPEN_PERSONAL_ACCOUNT'                                       => "Pers�nliches Kundenkonto er�ffnen",
'OR'                                                          => "oder",
'ORDERS'                                                      => "Bestellungen",
...
'OUR_REGULAR_PRICE'                                           => "(Unser regul�rer Preis.)",
'OXID_ESALES_URL'                                             => "http://www.oxid-esales.com/de/startseite",
'OXID_ESALES_URL_TITLE'                                       => "Shop Software von OXID eSales",
'PAGE'                                                        => "Seite",
'PARTNER_AND_SEAL'                                            => "G�tesiegel",
'PASSWORD'                                                    => "Passwort",
'PASSWORD_CHANGED'                                            => "Ihr Passwort wurde erfolgreich ge�ndert!",
...
'PERSONAL_SETTINGS'                                           => "Pers�nliche Einstellungen",
'PHONE'                                                       => "Telefon",
'PLEASE_CHOOSE'                                               => "Bitte w�hlen",
'PLEASE_SELECT_STATE'                                         => "Bitte w�hlen Sie ein Bundesland aus",
'PLUS'                                                        => "zzgl. ",
...
'PREVIOUS'                                                    => "Zur�ck",
'PREVIOUS_STEP'                                               => "Zur�ck",
'PREVIOUS_PRODUCT'                                            => "Artikel zur�ck",
'PRICE'                                                       => "Preis",
...
'PUBLIC_GIFT_REGISTRIES'                                      => "�ffentlicher Wunschzettel",
...
'READ_AND_CONFIRM_TERMS'                                      => "Bitte best�tigen Sie unsere Allg. Gesch�ftsbedingungen.",
'REASON'                                                      => "Grund",
'REBATE'                                                      => "Nachlass",
...
'REDEEM_COUPON'                                               => "Gutschein einl�sen",
'REDUCED_FROM'                                                => "Statt",
'REDUCED_FROM_2'                                              => "UVP",
...
'REQUEST_PASSWORD_AFTERCLICK'                                 => "Nachdem Sie den 'Passwort anfordern'-Knopf angeklickt haben, schicken wir Ihnen eine E-Mail zu, mit der Sie Ihr Passwort �ndern k�nnen.",
'RESET_SELECTION'                                             => "Auswahl zur�cksetzen",
'REVIEW'                                                      => "Bewerten",
'REVIEW_YOUR_ORDER'                                           => "Bitte Bestellung kontrollieren",
'ROOT_CATEGORY_CHANGED'                                       => "Hauptkategorie ver�ndert",
'SAVE'                                                        => "Speichern",
...
'SELECT'                                                      => "Ausw�hlen",
'SELECTED_COMBINATION'                                        => "Ausgew�hlte Kombination",
'SELECTED_SHIPPING_CARRIER'                                   => "Der Versand erfolgt mit",
'SELECT_ALL'                                                  => "Alle ausw�hlen",
'SELECT_LISTMANIA_LIST'                                       => "W�hlen Sie die Lieblingsliste",
'SELECT_SHIPPING_METHOD'                                      => "Bitte w�hlen Sie Ihre Versandart",
'SEND'                                                        => "Abschicken",
...
'SHOPLUPE'                                                    => "Shoplupe",
'SIMILAR_PRODUCTS'                                            => "�hnliche Produkte",
...
'STEPS_BASKET'                                                => "1. Warenkorb�bersicht",
'STEPS_ORDER'                                                 => "4. �berpr�fen & absenden",
'STEPS_PAY'                                                   => "3. Versand & Zahlungsart",
'STEPS_SEND'                                                  => "2. Adressen w�hlen ",
'STOCK'                                                       => "Lagerbestand",
'STOCK_LOW'                                                   => "Lagerbestand niedrig",
'STREET_AND_STREETNO'                                         => "Stra�e, Hausnummer",
'SUBJECT'                                                     => "Betreff",
'SUBMIT'                                                      => "Absenden",
...
'TRUSTED_SHOPS_IMGTITLE'                                      => "Klicken Sie auf das G�tesiegel, um die G�ltigkeit zu pr�fen!",
...
'TRUSTED_SHOP_BUYER_PROTECTION'                               => "Trusted Shops K�uferschutz",
'TRUSTED_SHOP_PROTECTION_FROM'                                => "K�uferschutz von",
'RATE_OUR_SHOP'                                               => "Bitte nehmen Sie sich eine Minute, um unseren Shop zu bewerten.",
'TRUSTED_SHOP_REGISTRATION'                                   => "Anmeldung zum Trusted Shops K�uferschutz",
'TRUSTED_SHOP_REGISTRATION_MESSAGE'                           => "Als zus�tzlichen Service bieten wir Ihnen den Trusted Shops K�uferschutz an. Wir �bernehmen alle Kosten dieser Garantie, Sie m�ssen sich lediglich anmelden.",
'TRUSTED_SHOP_SEAL_OF_APPROVAL'                               => "Trusted Shops G�tesiegel - Bitte hier G�ltigkeit pr�fen!",
'TRUSTED_SHOP_UNAVAILABLE_PROTECTION'                         => "Aufgrund technischer Probleme ist es nicht m�glich, den Trusted Shops K�uferschutz zu buchen. Sie k�nnen Ihren Einkauf ohne K�uferschutz abschlie�en. Bitte wenden Sie sich bei Fragen an service@trustedshops.de.",
...
'VALID_UNTIL'                                                 => "G�ltig bis",
'VAT'                                                         => "MwSt",
'VAT_ID_NUMBER'                                               => "USt-ID",
'VENDOR'                                                      => "Lieferant",
'VENDOR_S'                                                    => "| Lieferant: %s",
'VERIFICATION_CODE'                                           => "Pr�fcode",
...
'WRAPPING'                                                    => "Verpackung",
'WRAPPING_DESCRIPTION'                                        => "Wir verpacken Ihr Geschenk sehr gerne mit unserem sch�nen Geschenkpapier, oder lassen Sie uns eine Karte mit Ihrer pers�nlichen Nachricht beilegen.",
'WRAPPING_NET'                                                => "Geschenkverpackung/Gru�karte (netto)",
'WRITES'                                                      => "schreibt",
...
'YOUR_GREETING_CARD'                                          => "Ihre Gru�karte",
'YOUR_PREVIOUS_ORDER'                                         => "Ihre bereits get�tigten Bestellungen",
'YOUR_REVIEW'                                                 => "Ihre Bewertung",
'YOUR_PRICE'                                                  => "Ihr Preis",
'YOU_ARE_HERE'                                                => "Sie sind hier",
'YOU_CAN_GO'                                                  => "Sie k�nnen nun",
...
'OXSHOPINCL'                                                  => "Shop einschlie�en",
'OXSHOPEXCL'                                                  => "Shop ausschlie�en",
'OXEAN'                                                       => "EAN",
...
'OXSKIPDISCOUNTS'                                             => "Nachl�sse ignorieren",
'OXRATINGCNT'                                                 => "Bewertung Anzahl",
'OXRATING'                                                    => "Bewertung",
'OXRRVIEW'                                                    => "Ausschlie�lich sichtbar",
'OXRRBUY'                                                     => "Ausschlie�lich kaufbar",
...
//used as field translations ^
'ERROR_DELIVERY_ADDRESS_WAS_CHANGED_DURING_CHECKOUT'          => "Rechnungs- oder Lieferadresse wurde w�hrend der Bestellung ge�ndert. Bitte noch einmal pr�fen.",
'FACEBOOK_ENABLEINFOLINK'                                     => "Informationen �ber die Daten�bermittlung anzeigen.",
'FACEBOOK_ENABLELINK'                                         => "FACEBOOK INHALTE ANZEIGEN",
'FACEBOOK_ENABLETEXT'                                         => "Es werden Daten an Facebook �bermittelt.",
...
'LINK_VALID_UNTIL'                                             => "Downloadlink ist g�ltig bis",
...
'COOKIE_NOTE'                                                 => "Dieser Online-Shop verwendet Cookies f�r ein optimales Einkaufserlebnis. Dabei werden beispielsweise die Session-Informationen oder die Spracheinstellung auf Ihrem Rechner gespeichert. Ohne Cookies ist der Funktionsumfang des Online-Shops eingeschr�nkt.",
...
'BASKET_TOTAL_GIFTCARD_COSTS_NET'                             => "Gru�karte (netto)",
...
'PAGE_TITLE_ACCOUNT_PASSWORD'                                 => "Passwort �ndern",
...
'PAGE_TITLE_GUESTBOOK'                                        => "Unser G�stebuch",
'PAGE_TITLE_WISHLIST'                                         => "Merkzettel",
'PAGE_TITLE_CONTACT'                                          => "Kontakt",
'PAGE_TITLE_LINKS'                                            => "Links",
'YOUR_TEAM'                                                   => "Ihr %s Team",
'WISHLIST_PRODUCTS'                                           => "Diese Artikel hat sich %s gew�nscht. Wenn Sie ihr/ihm eine Freude machen wollen, dann kaufen Sie einen oder mehrere von diesen Artikeln.",


'BETA_NOTE'                                                   => "Willkommen zur Beta ",
'BETA_NOTE_MIDDLE'                                            => " von OXID eShop ",
'BETA_NOTE_FAQ'                                               => ". H�ufig gestellte Fragen und Antworten sind in der %s gelistet.",
...
'DETAILS_CHOOSEVARIANT'                                       => "Bitte w�hlen Sie eine Variante",
...
'SHOP_SUGGEST_MESSAGE'                                        => "Hallo, Heute habe ich den interessanten Shop %s f�r dich gefunden. Einfach auf den Link unten klicken, und du gelangst direkt zum Shop.",
'SHOP_SUGGEST_BUY_FOR_ME'                                     => "Hallo, ich habe mir hier bei %s einen Wunschzettel angelegt. Es w�re toll, wenn du mir davon etwas kaufen k�nntest.",
'GIFT_REGISTRY_SENT_SUCCESSFULLY'                             => "Ihr Wunschzettel wurde erfolgreich an %s verschickt!",
'INCLUDE_VAT'                                                 => "inkl. MwSt.",
'COD_CHARGE'                                                  => "Nachnahmegeb�hr",
'REGISTERED_YOUR_ORDER'                                       => "Ihre Bestellung ist unter der Nummer %s bei uns registriert.",
'THANK_YOU_FOR_ORDER'                                         => "Vielen Dank f�r Ihre Bestellung im",
'PRICE_ALERT_THANK_YOU_MESSAGE'                               => "Vielen Dank f�r Ihre Nachricht an %s. Sie bekommen eine Nachricht von uns sobald der Preis unter %s %s f�llt.",
'THANK_YOU_MESSAGE'                                           => "Vielen Dank f�r Ihre Nachricht an %s.",

'ALL_BRANDS'                                                  => "Alle Marken",
'BY_BRAND'                                                    => "Nach Marke",
'BY_MANUFACTURER'                                             => "Nach Hersteller",
'BY_VENDOR'                                                   => "Nach Lieferant",
'SEARCH_RESULT'                                               => "Suchergebnis f�r \"%s\"",
...
'INFO_ABOUT_COOKIES'                                          => "Information �ber Cookies",
'PARTNERS'                                                    => "Partner",

//not used
'EMAIL_ORDER_CUST_HTML_PAYMENTCHARGEVAT1'                     => "Aufsch. Zahl. MwSt.",
'FORM_REGISTER_COMPLETEMARKEDFIELDS'                          => "(Bitte alle fett beschrifteten Pflichtfelder ausf�llen.)",
'MESSAGE_NO_DELIVERY_METHOD'                                  => "<p>Derzeit ist keine Versandart f�r dieses Land definiert.</p> <p>Wir werden versuchen, Lieferm�glichkeiten zu finden und Sie �ber die Versandkosten informieren.</p> <p>Falls Sie hiermit einverstanden sind, w�hlen Sie \"Weiter zum n�chsten Schritt\".</p>",
'ERROR_MESSAGE_PAGE_HEADLINE'                                 => "Der Shop ist vor�bergehend offline...",
'MESSAGE_SELECTED_IPAYMENT'                                   => "Sie haben als Zahlungsart \"iPayment\" gew�hlt.<br>Sie werden nun automatisch an iPayment weitergeleitet, wo Sie Ihre erforderlichen Daten f�r eine Bezahlung mit \"iPayment\" eingeben k�nnen.<br><br>Wenn dies nicht der Fall sein sollte, -z.B. wenn Sie Javascript deaktiviert haben- klicken Sie bitte auf das folgende \"iPayment\"-Symbol,um den Vorgang manuell auszuf�hren.",
