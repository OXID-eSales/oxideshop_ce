...
'HELP_SHOP_MAIN_PRODUCTIVE'                   => 'F�r Installation, Konfiguration, Anpassung der Templates und Modul-Debugging sollte der Shop nicht im Produktivmodus sein. Sobald der Produktivmodus aktiviert ist, wird das Cache Handling und das Error Reporting f�r den Livebetrieb des Shops optimiert.<br>' .
                                                 ...
                                                 'Weitere wichtige Hinweise f�r den Livegang des OXID eShop finden Sie in unserer <a href="http://oxidforge.org/de/check-vor-dem-livegang.html" target="_blank">OXIDforge</a>.',
...
'HELP_SHOP_MAIN_ORDEREMAIL'                   => 'Wenn Benutzer bestellen, erhalten diese eine Bestellbest�tigung per E-Mail. Antwortet ein Benutzer auf diese E-Mail, wird die Antwort an die angegebene  Mailadresse gesendet.',

'HELP_SHOP_MAIN_OWNEREMAIL'                   => 'Wenn Benutzer bestellen, wird eine E-Mail an den eShop-Administrator gesendet. Die E-Mail �ber die eingegangene Bestellung geht an die angegebene Mailadresse.',
