                    ...
                    <table>
                        <tr id="firstTr">
                            ...
                            <td class="alignTop">
                                ...
                                [{/if}]
                                [{oxid_include_widget cl="oxwArticleBox" currencySign=$currency->sign _parent=$oView->getClassName() nocookie=1 _navurlparams=$oViewConf->getNavUrlParams() anid=$product->getId() iIteration=$smarty.foreach.comparelist.iteration oxwtemplate=page/compare/inc/compareitem.tpl}]
                            </td>
                            [{/foreach}]
                        </tr>
                        <tr>
