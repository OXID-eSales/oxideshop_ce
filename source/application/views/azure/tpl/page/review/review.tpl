...
[{capture append="oxidBlock_content"}]
    ...
    <div class="widgetBox reviews">
        ...
        [{assign var="product" value=$oView->getProduct()}]
        [{oxid_include_widget cl="oxwReviews" nocookie=1 noscript=1 _parent=$oView->getClassName() type=article anid=$product->oxarticles__oxnid->value reviewuserhash=$oView->getReviewUserHash()}]
    </div>
    [{/if}]
[{/capture}]
