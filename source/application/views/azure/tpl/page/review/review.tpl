...
[{capture append="oxidBlock_content"}]
    ...
    <div class="widgetBox reviews">
        ...
        [{assign var="product" value=$oView->getProduct()}]
        [{oxid_include_widget cl="oxwReview" nocookie=1 _parent=$oView->getClassName() type=oxarticle anid=$product->oxarticles__oxnid->value canrate=$oView->canRate() reviewuserhash=$oView->getReviewUserHash()}]
    </div>
    [{/if}]
[{/capture}]
