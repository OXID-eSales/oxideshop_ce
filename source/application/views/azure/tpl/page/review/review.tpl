...
[{capture append="oxidBlock_content"}]
    ...
    <div class="widgetBox reviews">
        ...
        [{/if}]
        [{oxid_include_widget cl="oxwReview" nocookie=1 force_sid=$force_sid _parent=$oView->getClassName() type=oxarticle anid=$product->oxarticles__oxnid->value aid=$product->oxarticles__oxid->value canrate=$oView->canRate() reviewuserhash=$oView->getReviewUserHash() skipreverceproxy=$oxcmp_user}]
    </div>
    [{/if}]
[{/capture}]
