    ...
    <ul class="[{$type}]View clear" id="[{$listId}]">
        [{foreach from=$products item=_product name=productlist}]
            ...
            <li class="productData">
                [{ oxid_include_widget cl="oxwArticleBox" cur=$oViewConf->getActCurrency() _parent=$oView->getClassName() nocookie=1 _navurlparams=$oViewConf->getNavUrlParams() productId=$_product->getId() sWidgetType=product sListType=listitem_$type testid=$_listid blDisableToCart=$blDisableToCart }]
            </li>
