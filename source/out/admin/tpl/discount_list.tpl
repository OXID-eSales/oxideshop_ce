...
<table cellspacing="0" cellpadding="0" border="0" width="100%">
    ...
    <tr>
        [{block name="admin_discount_list_sorting"}]
            <td class="listheader first" height="15" colspan="2">&nbsp;<a href="Javascript:top.oxid.admin.setSorting( document.search, 'oxdiscount', 'oxtitle', 'asc');document.search.submit();" class="listheader">[{ oxmultilang ident="GENERAL_NAME" }]</a></td>
        [{/block}]
    </tr>
