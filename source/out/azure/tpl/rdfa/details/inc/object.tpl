<div rel="gr:includes">
    ...
    [{/if}]
              [{if $oProduct->oxarticles__oxtitle->value}]
               ...
               [{if $oProduct->oxarticles__oxlongdesc->value}]
                   <div property="gr:description" content="[{$oProduct->oxarticles__oxlongdesc->value|strip_tags|strip}]" [{if $oView->getActiveLangAbbr()}] xml:lang="[{$oView->getActiveLangAbbr()}]"[{/if}]></div>
               [{/if}]
            [{/oxhasrights}]
