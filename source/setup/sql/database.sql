...
('1ea45574543b21636.29288751', 'oxrightofwithdrawal', 'oxbaseshop', 1, 0, 1, 1, '', 'Widerrufsrecht', '<div>Fügen Sie hier Ihre Widerrufsbelehrung ein.</div><div><a title="" href="/out/pictures/wysiwigpro/Model_form_for_withdrawal_de.pdf"><strong>Muster für das Widerrufsformular</strong></a></div>', 'Right of Withdrawal', '<div>Insert here the Right of Withdrawal policy.</div><div><strong><a title="" href="/out/pictures/wysiwigpro/Model_form_for_withdrawal_en.pdf">Model form for withdrawal</a></strong></div>', 1, '', '', 0, '', '', '30e44ab83fdee7564.23264141', 'CMSFOLDER_USERINFO', ''),
