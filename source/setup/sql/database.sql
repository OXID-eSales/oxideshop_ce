...
('2ed0ea12d74ab5bb3b128793bc5dbab5', 'oxtsinternationalfees', 'oxbaseshop', 1, 0, 1, 1, '', 'Trusted shops international fees text', '<span class="title">Bei Lieferung ins Nicht-EU-Ausland können zusätzlich Zölle, Steuern und Gebühren anfallen</span>', 'Trusted shops international fees text', '<span class="title">Delivery to non-EU countries may cause additional custom, taxes and fees</span>', 0, '', '', 0, '', '', '30e44ab83fdee7564.23264141', '', '');
# --------------------------------------------------------
...
('8f241f11095a29f47.04102343', 0, 'Grönland', 'GL', 'GRL', '304', 9999, 'Rest Europäische Union', '', 'Greenland', '', '', 'Rest of EU', '', '', '', '', '', 1),
