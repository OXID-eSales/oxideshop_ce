    ...
    <head>
        ...
        <style type="text/css">
            ...
            body, p, td, tr, ol, ul, input, textarea {
                font: 11px/130% Trebuchet MS, Tahoma, Verdana, Arial, Helvetica, sans-serif;
            }
            ...
            #body {
                clear: both;
                padding: 20px 10px;
                background: #e4e4e4 url(setup.png) 0 -80px repeat-x;
            ...
            dl.tab {
                float: left;
                width: <?php echo $iTabWidth; ?>px;
                height: 80px;
                margin: 0;
                margin-right: 1px;
                background: #ccc url(setup.png);
                border: 1px solid #ccc;
                border-bottom: none;
                margin-bottom: -1px;
            }
            ...
            dl.tab.act {
                border-color: <?php echo $sHColor; ?>;
            }

            dl.tab.act dt a {
                color: <?php echo $sHColor; ?>;
            }
            ...
            ul.req li.pass {
                background-image: url('./out/src/img/pass.png');
                background-repeat: no-repeat;
            }

            ul.req li.pmin {
                background-image: url('./out/src/img/pmin.png');
                background-repeat: no-repeat;
            }

            ul.req li.fail {
                background-image: url('./out/src/img/fail.png');
                background-repeat: no-repeat;
            }

            ul.req li.null {
                background-image: url('./out/src/img/null.png');
                background-repeat: no-repeat;
            }
