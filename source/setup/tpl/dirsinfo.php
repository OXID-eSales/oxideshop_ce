    ...
    <form action="index.php" method="post">
        ...
        <table cellpadding="0" cellspacing="5" border="0">
            <tr>
                ...
                <td>&nbsp;&nbsp;<input size="40" name="aPath[sShopURL]" class="editinput"
                                       value="<?php echo($aPath['sShopURL']); ?>"></td>
            </tr>
            <tr>
                <td><?php $this->getText('STEP_4_SHOP_DIR'); ?>:</td>
                <td>&nbsp;&nbsp;<input size="40" name="aPath[sShopDir]" class="editinput"
                                       value="<?php echo($aPath['sShopDir']); ?>"></td>
            </tr>
            <tr>
                <td><?php $this->getText('STEP_4_SHOP_TMP_DIR'); ?>:</td>
                <td>&nbsp;&nbsp;<input size="40" name="aPath[sCompileDir]" class="editinput"
                                       value="<?php echo($aPath['sCompileDir']); ?>"></td>
            </tr>
            <tr>
                <td colspan="2">&nbsp;</td>
            </tr>
            <tr>
                ...
                <td>&nbsp;&nbsp;<input size="40" name="aAdminData[sLoginName]" class="editinput"
                                       value="<?php echo($aAdminData['sLoginName']); ?>"></td>
            </tr>
            <tr>
                <td><?php $this->getText('STEP_4_ADMIN_PASS'); ?>:</td>
                <td>&nbsp;&nbsp;<input size="40" name="aAdminData[sPassword]" class="editinput"
                                       type="password"> <?php $this->getText('STEP_4_ADMIN_PASS_MINCHARS'); ?></td>
            </tr>
            <tr>
                <td><?php $this->getText('STEP_4_ADMIN_PASS_CONFIRM'); ?>:</td>
                <td>&nbsp;&nbsp;<input size="40" name="aAdminData[sPasswordConfirm]" class="editinput" type="password">
                </td>
            </tr>
            <tr>
                <td colspan="2">&nbsp;</td>
