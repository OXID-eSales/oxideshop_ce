...
?>
    ...
    <table cellspacing="5" cellpadding="5">
        <tr>
            ...
            <td><a href="<?php echo($aPath['sShopURL']); ?>/" target="_blank" id="linkToShop"
                   style="text-decoration: underline"><strong><?php $this->getText('STEP_6_TO_SHOP'); ?></strong></a>
            </td>
        </tr>
        <tr>
            <td><?php $this->getText('STEP_6_LINK_TO_SHOP_ADMIN_AREA'); ?>:</td>
            <td><a href="<?php echo($aPath['sShopURL']); ?>/admin/" target="_blank" id="linkToAdmin"
                   style="text-decoration: underline"><strong><?php $this->getText('STEP_6_TO_SHOP_ADMIN'); ?></strong></a>
            </td>
        </tr>
    </table>
    <br>
...
if (!$blRemoved) {
    ?><strong style="font-size:16px;color:red;"><?php $this->getText('SETUP_DIR_DELETE_NOTICE'); ?></strong><br>
    <br><?php
}
