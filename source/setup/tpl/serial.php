    ...
    <form action="index.php" method="post">
        ...
        <table cellpadding="0" cellspacing="5" border="0">
            <tr>
                ...
                <td>&nbsp;&nbsp;<input size="47" name="sLicence" class="editinput"
                                       value="<?php echo $this->getViewParam("sLicense"); ?>"></td>
                <td>&nbsp;&nbsp;<input type="submit" id="step5Submit" class="edittext"
                                       value="<?php $this->getText('BUTTON_WRITE_LICENCE'); ?>"></td>
            </tr>
        </table>
        <br>
