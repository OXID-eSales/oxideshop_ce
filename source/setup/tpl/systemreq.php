...
require "_header.php"; ?>
        ...
        <tr>
            ...
            <td>
                <form action="index.php" id="langSelectionForm" method="post">
                    <select name="setup_lang" onChange="document.getElementById('langSelectionForm').submit();"
                        ...
                        foreach ($aLanguages as $sLangId => $sLangTitle) {
                            ?>
                            <option
                                value="<?php echo $sLangId; ?>" <?php if ($this->getViewParam("sSetupLang") == $sLangId) {
                                echo 'selected';
                    ...
                    <noscript>
                        <input type="submit" name="setup_lang_submit"
                               value="<?php $this->getText('SELECT_SETUP_LANG_SUBMIT'); ?>" style="font-size: 11px;">
                    </noscript>
    ...
    <ul class="req">
        ...
        foreach ($aGroupModuleInfo as $sGroupName => $aGroupInfo) {
            ?>
            <li class="group"><?php echo $sGroupName; ?>
            <ul><?php
...
<?php if ($this->getViewParam("blContinue") === true) { ?>
    <form action="index.php" method="post">
        ...
        <input type="submit" id="step0Submit" class="edittext"
               value="<?php $this->getText('BUTTON_PROCEED_INSTALL'); ?>">
    </form>
<?php
} else {
