...
require "_header.php"; ?>
    ...
    <form action="index.php" method="post">
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" height="29">
                        <tr>
                            ...
                            <td style="padding: 0px 5px;">
                                <a href="#"
                                   style="display:block;width:18px;height:18px;background: #ddd;border: 1px solid #ccc;border-radius: 5px;line-height: 18px;text-align: center;font-weight: bold;color: #777;"
                                   onmouseover="document.getElementById('marketHelpBox').style.display = '';"
                                   onmouseout="document.getElementById('marketHelpBox').style.display = 'none';">?</a>

                                <div id="marketHelpBox"
                                     style="position: absolute;margin-top:5px;border: 1px solid #c1c1c1; background: #ddd;padding: 10px;border-radius: 5px;display: none;width:300px;">
                                ...
                                <td id="use_dynamic_pages_desc"
                                    ...
                                    <?php $this->getText('USE_DYNAMIC_PAGES'); ?><a
                                        ...
                                        onClick="showPopUp('<?php echo $sSetupLang; ?>/dyn_content_notice.php', 400, 200, 1); return false;"
                                        target="_blank"><u><?php $this->getText('PRIVACY_POLICY'); ?></u></a>.
                                </td>
                        </tr>
                    </table>
                </td>
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" height="29">
                        <tr>
                            ...
                            <td style="padding: 0px 5px;">
                                <a href="#"
                                   style="display:block;width:18px;height:18px;background: #ddd;border: 1px solid #ccc;border-radius: 5px;line-height: 18px;text-align: center;font-weight: bold;color: #777;"
                                   onmouseover="document.getElementById('countryHelpBox').style.display = '';"
                                   onmouseout="document.getElementById('countryHelpBox').style.display = 'none';">?</a>

                                <div id="countryHelpBox"
                                     style="position: absolute;margin-top:5px;border: 1px solid #c1c1c1; background: #ddd;padding: 10px;border-radius: 5px;display: none;width:300px;">
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" height="29">
                        <tr>
                            ...
                            <td style="padding: 0px 5px;">
                                <a href="#"
                                   style="display:block;width:18px;height:18px;background: #ddd;border: 1px solid #ccc;border-radius: 5px;line-height: 18px;text-align: center;font-weight: bold;color: #777;"
                                   onmouseover="document.getElementById('langHelpBox').style.display = '';"
                                   onmouseout="document.getElementById('langHelpBox').style.display = 'none';">?</a>
        ...
        <input type="checkbox" id="check_for_updates_ckbox" value="true" name="check_for_updates" valign=""
               style="vertical-align:middle; width:20px; height:22px;">
