...
REPLACE INTO `oxdiscount` (`OXID`,            `OXSHOPID`,  `OXACTIVE`, `OXTITLE`,                          `OXTITLE_1`,                        `OXAMOUNT`, `OXAMOUNTTO`, `OXPRICETO`, `OXPRICE`, `OXADDSUMTYPE`, `OXADDSUM`, `OXITMARTID`, `OXITMAMOUNT`, `OXITMMULTIPLE`, `OXSORT`) VALUES
                         ...
                         ('testitmdiscount', 1, 1,         'Itm discount [DE] šÄßüл',          'Itm discount [EN] šÄßüл',           5,          999999,       0,           0,        'itm',           0,         '1003',        1,             0, 120),
                         ('testdiscount4',   1, 0,         '4 DE test discount šÄßüл',         '4 EN test discount šÄßüл',          0,          0,            0,           0,        'abs',           0,         '',            0,             0, 130),
                         ('testdiscount3',   1, 0,         '3 DE test discount šÄßüл',         '2 EN test discount šÄßüл',          0,          0,            0,           0,        'abs',           0,         '',            0,             0, 140),
                         ('testdiscount1',   1, 1,         '1 DE test discount šÄßüл',         '[last] EN test discount šÄßüл',     0,          999999,       999999,      0,        'abs',           5,         '',            0,             0, 150),
                         ('testdiscount2',   1, 0,         '2 DE test discount šÄßüл',         '3 EN test discount šÄßüл',          0,          0,            0,           0,        'abs',           0,         '',            0,             0, 160),
                         ('testdiscount5',   1, 0,         '[last] DE test discount šÄßüл',    '1 EN test discount šÄßüл',          1,          999999,       0,           0,        'abs',           10,        '',            0,             0, 170);
