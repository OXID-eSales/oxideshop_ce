...
use OxidEsales\Codeception\Admin\Product\PictureAltProductPage;
use OxidEsales\EshopCommunity\Tests\Codeception\Support\AcceptanceTester;

#[Group('admin', 'product', 'imagealt')]
final class ProductPictureAltCest
{
    ...
    public function imageAltTabShowsImagesForProduct(AcceptanceTester $I): void
    {
        ...
        $imageAltTab = $this->openPictureAltTab($I);
    ...
    private function openPictureAltTab(AcceptanceTester $I): PictureAltProductPage
    {
        $adminPanel = $I->loginAdmin();
        $products = $adminPanel->openProducts();
        $mainProductPage = $products->findByProductNumber($this->productNumber);

        return $mainProductPage->openPictureAltTab();
    }
}
