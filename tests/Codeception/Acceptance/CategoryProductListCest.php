...
final class CategoryProductListCest
{
    ...
    public function sortAndNavigateThroughCategoryList(AcceptanceTester $I): void
    {
        ...
        $productList->selectSorting('oxtitle', 'asc')
            ...
            ->seeProductPictureAltText($productData['title'], 1)
            ->seeProductPictureAltText($mediaFixture['primaryAltText'], 2)
    ...
    private function setNumberOfProductsInCategoryList(AcceptanceTester $I): void
    {
        ...
        $I->updateThemeSetting('numberOfCategoryProducts', ['20', '1', '2', '10', '100']);
        $I->updateThemeSetting('numberOfCategoryProductsInGrid', ['20', '1', '2', '10', '100']);
    }
}
