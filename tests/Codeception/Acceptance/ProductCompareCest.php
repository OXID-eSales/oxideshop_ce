...
final class ProductCompareCest
{
    ...
    public function addProductToUserCompareList(AcceptanceTester $I): void
    {
        ...
        $comparePage->seeProductPictureAltText($productData1['title'], 1);
        $comparePage->seeProductPictureAltText($mediaFixture['primaryAltText'], 2);
        $comparePage->seeProductPictureAltText($productData3['title'], 3);
    ...
    public function disableProductCompare(AcceptanceTester $I): void
    {
        ...
        $I->updateThemeSetting('bl_showCompareList', false);
        ...
        $I->updateThemeSetting('bl_showCompareList', true);
    }
