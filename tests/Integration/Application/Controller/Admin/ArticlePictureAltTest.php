...
use OxidEsales\EshopCommunity\Application\Controller\Admin\ArticlePictureAlt;
...
final class ArticlePictureAltTest extends IntegrationTestCase
{
    use ContainerTrait;
    ...
    public function testRenderIncludesAllProductImages(): void
    {
        ...
        $controller = $this->get(ArticlePictureAlt::class);
    ...
    public function testSaveStoresAllLocalesForSelectedImage(): void
    {
        ...
        $controller2 = $this->get(ArticlePictureAlt::class);
    ...
    public function testSaveIgnoresImagesNotSelected(): void
    {
        ...
        $this->assertFalse($dao->getAttributes($otherMediaId, new LocaleChain(['de_DE']), 1)->has(MediaAttribute::ALT));
    }
    ...
    public function testSaveRemovesAltWhenTextIsEmpty(): void
    {
        ...
        $controller3 = $this->get(ArticlePictureAlt::class);
