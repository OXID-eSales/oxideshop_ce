...
class ActionsTest extends IntegrationTestCase
{
    ...
    public function testAddArticle()
    {
        ...
        $this->assertNotEmpty($sCheckOxid);
    }
    ...
    public function testGetBannerArticle_notAssigned()
    {
        ...
        $promotionMock = $this->createPartialMock(\OxidEsales\Eshop\Application\Model\Actions::class, array('fetchBannerArticleId'));
    ...
    public function testGetBannerArticle_notExisting()
    {
        ...
        $oArticle = $this->createPartialMock('stdclass', array('load'));
    ...
    {
        $this->markTestSkipped("doesnt work, configuration missmatch?");
    ...
    public function testGetBannerPictureUrl_pictureNotUploaded()
    {
        ...
        $this->assertEquals(Registry::getConfig()->getPictureUrl("master/") . "nopic.jpg", $oPromo->getBannerPictureUrl());
    }
    ...
    public function testGetBannerLink()
    {
        ...
        $oUtilsUrl = $this->createPartialMock(\OxidEsales\Eshop\Core\UtilsUrl::class, array('processUrl', 'addShopHost'));
    ...
    {
        $oArticle = $this->createPartialMock(Article::class, array('getLink'));
        $oArticle->expects($this->once())->method('getLink')
            ->will($this->returnValue("testLinkToArticle"));

        $oPromo = $this->createPartialMock(\OxidEsales\Eshop\Application\Model\Actions::class, array('getBannerArticle'));
