 ...
 */
class AddressTest extends IntegrationTestCase
{
    ...
    {
        $oSubj = $this->createPartialMock(\OxidEsales\Eshop\Application\Model\Address::class, array("toString"));
    ...
    {
        $this->markTestSkipped("doesnt work, onconsecutive call rewrite needed");
