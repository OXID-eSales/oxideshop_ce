...
class DatabaseTest extends DatabaseInterfaceImplementation
{
     ...
     * @return array
     */
    public static function dataProviderTestSelectLimitForInvalidOffsetAndLimit()
    {
        return array(
            array(
    ...
    public static function dataProviderTestQuoteIdentifierWithInvalidValues()
    {
        return [
            [
    ...
    public static function dataProviderTestQuoteWithInvalidValues()
    {
        return [
