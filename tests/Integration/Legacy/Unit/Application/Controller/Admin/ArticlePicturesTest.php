...
class ArticlePicturesTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testDeletePicture_deletingIcon()
    {
        ...
        $oArtPic = $this->getMock(\OxidEsales\Eshop\Application\Controller\Admin\ArticlePictures::class, ["deleteThumbnail", "deleteMasterPicture"]);
    ...
    public function testDeletePicture_deletingThumbnail()
    {
        ...
        $oArtPic = $this->getMock(\OxidEsales\Eshop\Application\Controller\Admin\ArticlePictures::class, ["deleteMainIcon", "deleteMasterPicture"]);
    ...
    public function testDeletePicture_deletingMasterPic()
    {
        ...
        $oArtPic = $this->getMock(\OxidEsales\Eshop\Application\Controller\Admin\ArticlePictures::class, ["deleteMainIcon", "deleteThumbnail"]);
        $oArtPic->expects($this->never())->method('deleteMainIcon');
        $oArtPic->expects($this->never())->method('deleteThumbnail');
