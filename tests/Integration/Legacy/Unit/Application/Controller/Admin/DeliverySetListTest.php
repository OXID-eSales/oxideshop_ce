...
class DeliverySetListTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testRender()
    {
        ...
        $this->assertSame('oxdeliveryset', $oView->getNonPublicVar("_sListClass"));
        $this->assertSame('oxdeliverysetlist', $oView->getNonPublicVar("_sListType"));
        $this->assertSame(["oxdeliveryset" => ["oxpos" => "asc"]], $oView->getListSorting());
        $this->assertSame('deliveryset_list', $oView->render());
    }
}
