 ...
 */
class ShopSeoTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        // defining parameters
        $aUrls = ['oxseo__oxstdurl' => "stdurl", 'oxseo__oxseourl' => ["seourl1", "seourl2"]];

        // testing..
        $oView = $this->getMock(\OxidEsales\Eshop\Application\Controller\Admin\ShopSeo::class, ["cleanupUrl"]);
        $oView
            ->method('cleanupUrl')
            ->withConsecutive(
                ['stdurl'],
