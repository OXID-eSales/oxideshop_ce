...
if (!class_exists(\OxidEsales\EshopEnterprise\Application\Model\CategoryList::class)) {
    class_alias('oxCategoryList', \OxidEsales\EshopEnterprise\Application\Model\CategoryList::class);
}
...
class oxCategoryListHelperLoadCategoryMenusEE extends \OxidEsales\EshopEnterprise\Application\Model\CategoryList
{
    ...
    public function loadCatMenues()
    {
        ...
        $aResult = [$sActCat => [$oContent1, $oContent2]];
        $this->assign($aResult);
    }
}
...
class CategoryListTest extends \OxidTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->_aActPath = $this->getTestConfig()->getShopEdition() === 'EE' ? [$this->_sActRoot, '30e44ab8593023055.23928895', $this->_sActCat] : [$this->_sActRoot, $this->_sActCat];
    ...
    public function test_getDepthSqlSnippet_actcat()
    {
        ...
        $sCurSnippet = $this->_oList->getDepthSqlSnippet($oCat);
    ...
    public function test_getSelectString_order()
    {
        ...
        $sCurSql = $this->_oList->getSelectString();
    ...
    public function test_getDepthSqlUnion()
    {
        ...
        $this->assertEquals("UNION SELECT qqqqq FROM oxcategories AS subcats LEFT JOIN $sViewName AS maincats on maincats.oxparentid = subcats.oxparentid WHERE subcats.oxrootid = 'rootid' AND subcats.oxleft <= 151 AND subcats.oxright >= 959", $oList->getDepthSqlUnion($oCat));
        ...
        $this->assertEquals("UNION SELECT qqqqq FROM oxcategories AS subcats LEFT JOIN $sViewName AS maincats on maincats.oxparentid = subcats.oxparentid WHERE subcats.oxrootid = 'rootid' AND subcats.oxleft <= 151 AND subcats.oxright >= 959", $oList->getDepthSqlUnion($oCat, 'lalala'));
    ...
    public function test_ppRemoveInactiveCategories()
    {
        ...
        $this->_oList->ppRemoveInactiveCategories();
    ...
    public function test_ppAddContentCategories()
    {
        ...
        $this->_oList->load();
        $this->_oList->ppAddContentCategories();
    ...
    public function test_ppBuildTree_Path()
    {
        ...
        $this->_oList->selectString($this->_oList->getSelectString(true));
        $this->_oList->ppBuildTree();
    ...
    public function test_ppAddDepthInformation()
    {
        ...
        $this->_oList->selectString($this->_oList->getSelectString(false));
        $this->_oList->ppBuildTree();
        $this->_oList->ppAddDepthInformation();
    ...
    public function test_addDepthInfo()
    {
        ...
        $aNewTree = $this->_oList->addDepthInfo($aTree, $oCat2);
        $sDepth = "";
    ...
    {
        $oCatList = $this->getMock($this->classForMock, ['load', 'ppRemoveInactiveCategories', 'ppAddPathInfo', 'ppAddContentCategories', 'ppBuildTree', 'ppLoadFullCategory']);
        $oCatList->expects($this->atLeastOnce())->method('load');
        $oCatList->expects($this->atLeastOnce())->method('ppRemoveInactiveCategories');
        $oCatList->expects($this->atLeastOnce())->method('ppLoadFullCategory');
        $oCatList->expects($this->atLeastOnce())->method('ppAddPathInfo');
        $oCatList->expects($this->atLeastOnce())->method('ppAddContentCategories');
        $oCatList->expects($this->atLeastOnce())->method('ppBuildTree');
    ...
    public function testUpdateCategoryTreeUpdateNodes()
    {
        ...
        if ($this->getTestConfig()->getShopEdition() === 'EE') {
            $aUpdateInfo = ['*** <b>SHOP : 1</b><br><br>', '<b>Processing : Eco-Fashion</b>(943a9ba3050e78b443c16e043ae60ef3)<br>', '<b>Processing : Für Sie</b>(30e44ab82c03c3848.49471214)<br>', '<b>Processing : Für Ihn</b>(30e44ab834ea42417.86131097)<br>', '<b>Processing : Wohnen</b>(30e44ab83b6e585c9.63147165)<br>', '<b>Processing : Party</b>(30e44ab83fdee7564.23264141)<br>', '<b>Processing : Outdoor</b>(30e44ab83d52c6d74.06410508)<br>', '<b>Processing : Spiele</b>(30e44ab8539ce4931.41747937)<br>', '<b>Processing : 1-8|1-8</b>(_test1)<br>'];
        } else {
            $aUpdateInfo = ['<b>Processing : Eco-Fashion</b>(943a9ba3050e78b443c16e043ae60ef3)<br>', '<b>Processing : Geschenke</b>(8a142c3e4143562a5.46426637)<br>', '<b>Processing : 1-8|1-8</b>(_test1)<br>'];
        }
