...
class RecommlistTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testGetRecommListsSorting()
    {
        ...
        $aExpectFirstArticleCases = [['testlist1' => $aArticles[0], 'testlist2' => $aArticles[1], 'testlist3' => $aArticles[2]], ['testlist1' => $aArticles[1], 'testlist2' => $aArticles[0], 'testlist3' => $aArticles[2]], ['testlist1' => $aArticles[0], 'testlist2' => $aArticles[1], 'testlist3' => $aArticles[3]], ['testlist1' => $aArticles[1], 'testlist2' => $aArticles[0], 'testlist3' => $aArticles[3]]];
