...
class VoucherTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected $_aSerieOxid;

    protected $_aVoucherOxid = [];

    protected $_sTestUserId;
    ...
    public function testFirstVoucherAcceptableSecondNotAllowedWithSameSeries()
    {
        ...
        try {
            $this->assertTrue($oNewVoucher->checkBasketVoucherAvailability($aVouchers, 100));
        } catch (\OxidEsales\EshopCommunity\Core\Exception\VoucherException $voucherException) {
            $this->assertSame('ERROR_MESSAGE_VOUCHER_NOTALLOWEDSAMESERIES', $voucherException->getMessage());
    ...
    public function testFirstVoucherAcceptableSecondNotAllowedWithOtherSeries()
    {
        ...
        try {
            ...
            $this->assertSame('ERROR_MESSAGE_VOUCHER_NOTALLOWEDOTHERSERIES', $voucherException->getMessage());
    ...
    public function testGetVoucherByNr0()
    {
        ...
        } catch (\OxidEsales\EshopCommunity\Core\Exception\VoucherException) {
            return; //OK
        }
    ...
    public function testGetVoucherByNr1()
    {
        ...
        $oNewVoucher = oxNew('oxvoucher');
        $oNewVoucher->getVoucherByNr($sNr);
        $this->assertSame($sNr, $oNewVoucher->oxvouchers__oxvouchernr->value);
    }
    ...
    public function testGetDiscountValueABS0()
    {
        ...
        $this->assertEqualsWithDelta(0.99, $oNewVoucher->getDiscountValue(100), PHP_FLOAT_EPSILON);
    }
    ...
    public function testGetDiscountValuePERC()
    {
        ...
        $this->assertEqualsWithDelta(9.99, $oNewVoucher->getDiscountValue(100), PHP_FLOAT_EPSILON);
    }
    ...
    public function testGetDiscountValue0()
    {
        ...
        $this->assertSame(0, $oNewVoucher->getDiscountValue(null));
    }
    ...
    public function testCheckVoucherAvailabilityInvalidTime()
    {
        ...
        try {
            ...
            $this->assertSame('ERROR_MESSAGE_VOUCHER_NOVOUCHER', $voucherException->getMessage());
    ...
    public function testIsAvailablePriceWhenPriceDiscountIsNotCorrect()
    {
        ...
        try {
            $aErrors = $oNewVoucher->isAvailablePrice($dPrice);
        } catch (\OxidEsales\EshopCommunity\Core\Exception\VoucherException) {
            $this->fail();
    ...
    public function testIsAvailablePriceWhenPriceIsBelowMinVal()
    {
        ...
        $myCurr = new stdclass();
        $myCurr->rate = 1000;
        $oConfig->expects($this->once())->method('getActShopCurrencyObject')->willReturn($myCurr);
        $oSerie = oxNew('oxvoucherserie');
        $oSerie->load($this->_aSerieOxid[0]);
        ...
        try {
            ...
            $sErrorMsg = $voucherException->getMessage();
        }

        $this->assertSame('ERROR_MESSAGE_VOUCHER_INCORRECTPRICE', $sErrorMsg);
    }
    ...
    public function testIsAvailableWithSameSeries0()
    {
        ...
        $aVouchers = null;
        $blAvailable = $oNewVoucher->isAvailableWithSameSeries($aVouchers);
        $this->assertEquals(true, $blAvailable);
        $blAvailable = $oNewVoucher->isAvailableWithSameSeries([$sOXID => 'ss']);
        $this->assertEquals(true, $blAvailable);
    }
    ...
    public function testIsAvailableWithSameSeries1()
    {
        ...
        try {
            $oNewVoucher->isAvailableWithSameSeries($aVouchers);
        } catch (\OxidEsales\EshopCommunity\Core\Exception\VoucherException) {
            return; //OK
        }
    ...
    public function testIsAvailableWithOtherSeries0()
    {
        ...
        $aVouchers = null;
        $blAvailable = $oNewVoucher->isAvailableWithOtherSeries($aVouchers);
        $this->assertEquals(true, $blAvailable);
    }
    ...
    public function testIsAvailableWithOtherSeries1()
    {
        ...
        try {
            $oNewVoucher->isAvailableWithOtherSeries($aVouchers);
        } catch (\OxidEsales\EshopCommunity\Core\Exception\VoucherException) {
            return; //OK
        }
    ...
    public function testIsValidDateCustomDateWasNotSet()
    {
        ...
        $this->assertEquals(true, $oNewVoucher->isValidDate());
    }
    ...
    public function testIsValidDate3_2()
    {
        ...
        try {
            ...
            $this->assertSame('MESSAGE_COUPON_EXPIRED', $voucherException->getMessage());
    ...
    public function testIsNotReserved0()
    {
        ...
        try {
            $oNewVoucher->isNotReserved();
        } catch (\OxidEsales\EshopCommunity\Core\Exception\VoucherException $voucherException) {
            $this->assertSame('EXCEPTION_VOUCHER_ISRESERVED', $voucherException->getMessage());
    ...
    public function testIsNotReserved1()
    {
        ...
        $this->assertEquals(true, $oNewVoucher->isNotReserved());
    }
    ...
    public function testCheckUserAvailabilityIfNotValidUserGroup()
    {
        ...
        try {
            ...
            $this->assertSame('ERROR_MESSAGE_VOUCHER_NOTVALIDUSERGROUP', $voucherException->getMessage());
    ...
    public function testIsAvailableInOtherOrder0()
    {
        ...
        $this->assertEquals(true, $oNewVoucher->isAvailableInOtherOrder(null));
    }
    ...
    public function testIsAvailableInOtherOrder1()
    {
        ...
        $this->assertEquals(true, $oNewVoucher->isAvailableInOtherOrder($oUser));
    }
    ...
    public function testIsAvailableInOtherOrder2()
    {
        ...
        try {
            $oNewVoucher->isAvailableInOtherOrder($oUser);
        } catch (\OxidEsales\EshopCommunity\Core\Exception\VoucherException) {
            return; //OK
        }
    ...
    public function testIsValidUserGroupNotValidGroup()
    {
        ...
        try {
            $this->assertEquals(false, $oNewVoucher->isValidUserGroup($oUser));
        } catch (\OxidEsales\EshopCommunity\Core\Exception\VoucherException) {
            return; //OK
        }
    ...
    public function testIsValidUserGroupIfValidGroup()
    {
        ...
        $this->assertTrue($oNewVoucher->isValidUserGroup($oUser));
    }
    ...
    public function testIsValidUserGroupNoUser()
    {
        ...
        try {
            $oNewVoucher->isValidUserGroup(null);
        } catch (\OxidEsales\EshopCommunity\Core\Exception\VoucherException) {
            return;
        }
    ...
    public function testIsValidUserGroupNoUserGroupSet()
    {
        ...
        $this->assertTrue($oNewVoucher->isValidUserGroup(null));
    }
    ...
    public function testMarkAsUsedExistingMarking()
    {
        ...
        \OxidEsales\Eshop\Core\Registry::getUtilsDate()->setTime(0);
        ...
        $this->assertSame('xxx', $oVoucher->oxvouchers__oxorderid->value);
        $this->assertSame('yyy', $oVoucher->oxvouchers__oxuserid->value);
        $this->assertSame('1970-01-01', $oVoucher->oxvouchers__oxdateused->value);
    ...
    public function testFor0002662()
    {
        ...
        $oVoucher = $this->getMock(\OxidEsales\Eshop\Application\Model\Voucher::class, ["getSerieDiscount", "getBasketItems", "isAdmin"]);
        $oVoucher->expects($this->once())->method('getSerieDiscount')->willReturn($oDiscount);
        $oVoucher->expects($this->once())->method('getBasketItems')->willReturn([$oBasketItem1]);
        $oVoucher->method('isAdmin')->willReturn(false);

        $this->assertEqualsWithDelta(54.5, $oVoucher->getCategoryDiscountValue($dPrice), PHP_FLOAT_EPSILON);
    }
    ...
    {
        return random_int(1, self::MAX_LOOP_AMOUNT - 1);
    }
}
