...
class OnlineLicenseCheckTest extends \PHPUnit\Framework\TestCase
{
    public function testRequestFormation()
    {
        ...
        $activeAdminUsers = 10;
        $subShops = 5;
        $servers = ['7da43ed884a1ad1d6035d4c1d630fc4e' => ['id' => '7da43ed884a1ad1d6035d4c1d630fc4e', 'timestamp' => '1409911182', 'ip' => null, 'lastFrontendUsage' => '1409911182', 'lastAdminUsage' => null]];
        $counters = [['name' => 'admin users', 'value' => $adminUsers], ['name' => 'active admin users', 'value' => $activeAdminUsers], ['name' => 'subShops', 'value' => $subShops]];
        ...
        $caller = $this->getMockBuilder(\OxidEsales\Eshop\Core\OnlineLicenseCheckCaller::class)
    ...
    public function testSerialsAreTakenFromConfigInShopSerialsValidation()
    {
        ...
        $request->pVersion = '1.1';
        $request->productId = 'eShop';
        $request->keys = ['key' => ['key1', 'key2']];

        $request->productSpecificInformation = new stdClass();
        $request->productSpecificInformation->servers = ['server' => $servers];
        $request->productSpecificInformation->counters = ['counter' => $counters];

        $this->getConfig()->setConfigParam("aSerials", ['key1', 'key2']);
    ...
    {
        $subShops = 5;
        $counters = [['name' => 'subShops', 'value' => $subShops]];
        ...
        $request->pVersion = '1.1';
        $request->productId = 'eShop';
        $keys = ['key1', 'key2', ['attributes' => ['state' => 'new'], 'value' => 'new_serial']];
        $request->keys = ['key' => $keys];
    ...
    private function getApplicationServerExporterMock($appServerList)
    {
        ...
        $exporter = $this->getMockBuilder(\OxidEsales\Eshop\Core\Service\ApplicationServerExporter::class)
