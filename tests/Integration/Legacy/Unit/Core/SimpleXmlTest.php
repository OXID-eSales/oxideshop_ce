...
class SimpleXmlTest extends \PHPUnit\Framework\TestCase
{
    public function testObjectToXml()
    {
        ...
        $oTestObject->keys->key = ["testKey1", "someSpecialCharsValue&€#", "testKey2"];
    ...
    public function testObjectToXmlWithElementsWithAttributesKey()
    {
        ...
        $oTestObject->attributes->attribute = ['attrValue1', 'attrValue2', 'attribValueWithSpecialChars&#€'];
    ...
    public function testObjectToXmlWithAssocArrayKeys()
    {
        ...
        $oTestObject = oxNew('StdClass');
        $oTestObject->elements = ['element' => [['key1' => 'value1', 'key2' =>'value2 with special chars &#€', 'key3' => 'value3'], ['key1' => 'value1', 'key2' =>'value2 with special chars &#€', 'key3' => 'value3']]];
