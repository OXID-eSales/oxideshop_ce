...
class DbRestore
{
    ...
    /**
     * Returns database restoration mode.
     *
     * @return int
     */
     ...
     * @param bool   $blCheckChecksum  Whether to check table checksum before restoration
    ...
    public function dumpDB()
    {
        ...
        if (empty($aTables)) {
            ...
            throw new Exception(
                "no tables on "
                . oxRegistry::getConfig()->getConfigParam('dbHost') . ":$sDbName, using "
