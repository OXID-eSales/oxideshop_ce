 ...
 */
class DeliveryShippingCostCalculationTest extends IntegrationTestCase
{
    /**
     ...
     */
    public static function providerDeliveryCostRules()
    {
        $data = array();
     ...
     */
    public static function providerDeliveryCostRulesWithCategoryAssigned()
    {
        $data = array();
     ...
     */
    public static function providerQuantityCostRulesWithCategoryAssigned()
    {
        $data = array();
     ...
     * Data provider for testDeliveryCostRulesWithCategoryAssigned.
     */
    public static function providerDeliveryCostRulesWithArticleAssigned()
    {
        $data = array();
    ...
    private function insertArticle($oxArtNum = '666-T-V', $categories = null)
    {
        ...
        $categories = is_null($categories) ? $this->categoryIds : $categories;
