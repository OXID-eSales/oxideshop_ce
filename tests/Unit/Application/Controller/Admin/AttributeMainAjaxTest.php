...
class AttributeMainAjaxTest extends \OxidTestCase
{
    ...
    {
        $oView = $this->getMock(\OxidEsales\Eshop\Application\Controller\Admin\AttributeMainAjax::class, array("getActionIds"));
    ...
    public function testAddAttrArticle()
    {
        ...
        $oView = $this->getMock(\OxidEsales\Eshop\Application\Controller\Admin\AttributeMainAjax::class, array("getActionIds"));
        $oView->expects($this->any())->method('getActionIds')->will($this->returnValue(array('_testOxidAdd1', '_testOxidAdd2')));
