...
class VendorMainAjaxTest extends \OxidTestCase
{
    ...
    public function testGetQuery_selectingMainArticles()
    {
        ...
        $this->assertEquals($sQuery, preg_replace("/\s+/", " ", trim($oView->getQuery())));
    }
    ...
    public function testAddFilter_VariantsOff()
    {
        ...
        $oView = oxNew('vendor_main_ajax');
        $this->assertEquals("select * from oxarticles", trim($oView->addFilter('select * from oxarticles')));
    }
    ...
    public function testAddFilter_VariantsOn()
    {
        ...
        $oView = oxNew('vendor_main_ajax');
        $this->assertEquals("select * from oxarticles group by " . $this->getArticleViewTable() . ".oxid", trim($oView->addFilter('select * from oxarticles')));
    }
    ...
    public function testRemoveVendor_oneArticle()
    {
        ...
        $oView = $this->getMock(\OxidEsales\Eshop\Application\Controller\Admin\VendorMainAjax::class, array("getActionIds"));
        $oView->expects($this->any())->method('getActionIds')->will($this->returnValue(array('_testArticle1')));
    ...
    public function testRemoveVendor_resetingCounter()
    {
        ...
        $oView = $this->getMock(\OxidEsales\Eshop\Application\Controller\Admin\VendorMainAjax::class, array("getActionIds", "resetCounter"));
        $oView->expects($this->any())->method('getActionIds')->will($this->returnValue(array('_testArticle1')));
    ...
    public function testAddVendor_oneArticle()
    {
        ...
        $oView = $this->getMock(\OxidEsales\Eshop\Application\Controller\Admin\VendorMainAjax::class, array("getActionIds"));
        $oView->expects($this->any())->method('getActionIds')->will($this->returnValue(array('_testArticle3')));
    ...
    public function testAddVendor_allArticles()
    {
        ...
        $oView = $this->getMock(\OxidEsales\Eshop\Application\Controller\Admin\VendorMainAjax::class, array("getQuery"));
