...
class VoucherseriegroupsajaxTest extends \OxidTestCase
{
    ...
    public function testRemoveGroupFromVoucher_oneRecords()
    {
        ...
        $oView = $this->getMock(\OxidEsales\Eshop\Application\Controller\Admin\VoucherSerieGroupsAjax::class, array("getActionIds"));
        $oView->expects($this->any())->method('getActionIds')->will($this->returnValue(array('_testId1')));
    ...
    public function testAddGroupToVoucher_allGroups()
    {
        ...
        $oView = $this->getMock(\OxidEsales\Eshop\Application\Controller\Admin\VoucherSerieGroupsAjax::class, array("getQuery"));
        $oView->expects($this->once())->method('getQuery')->will($this->returnValue("from oxv_oxgroups_de where oxid like '\_test%'"));
    ...
    public function testAddGroupToVoucher_someGroups()
    {
        ...
        $oView = $this->getMock(\OxidEsales\Eshop\Application\Controller\Admin\VoucherSerieGroupsAjax::class, array("getActionIds"));
        $oView->expects($this->once())->method('getActionIds')->will($this->returnValue(array('_testGroupId3')));
