...
class ViewConfigTest extends \OxidTestCase
{
    ...
    public function testGetViewThemeParamReadsDirectlyFromConfig()
    {
        ...
        $viewConfigStub = $this->getMockBuilder(ViewConfig::class)
            ->setMethods(['getConfig'])
            ->getMock();
        $viewConfigStub->method('getConfig')->willReturn($configStub);

        $viewConfigStub->getConfig()->setConfigParam('someParameter', 'someValue');
        $this->assertEquals('someValue', $viewConfigStub->getViewThemeParam('someParameter'));

        /** Set and read the value again to discover caching issues */
        $viewConfigStub->getConfig()->setConfigParam('someParameter', 'otherValue');
        $this->assertEquals('otherValue', $viewConfigStub->getViewThemeParam('someParameter'));
    }
