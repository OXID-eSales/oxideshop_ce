...
final class SeoEncoderRecommTest extends \OxidTestCase
{
    ...
    public function testGetRecommUriCallCheckCantBeLoaded()
    {
        ...
        $oRecomm = $this->getMock(RecommendationList::class, array("getId", "getBaseStdLink"));
        ...
        $oEncoder = $this->getMock(SeoEncoderRecomm::class, array("loadFromDb", "getStaticUri", "prepareTitle", "processSeoUrl", "saveToDb"));
    ...
    public function testGetRecommUriCallCheck()
    {
        ...
        $oRecomm = $this->getMock(RecommendationList::class, array("getId", "getBaseStdLink", "getStdLink"));
        $oRecomm->expects($this->any())->method('getId')->will($this->returnValue("testRecommId"));
    ...
    public function testGetRecommUrl()
    {
        ...
        $oEncoder = $this->getMock(SeoEncoderRecomm::class, array("getFullUrl", "getRecommUri"));
    ...
    public function testGetRecommPageUrl()
    {
        ...
        $oEncoder = $this->getMock(SeoEncoderRecomm::class, array('getStaticUri'));
