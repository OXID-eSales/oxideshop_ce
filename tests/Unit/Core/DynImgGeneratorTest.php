...
final class DynImgGeneratorTest extends \OxidTestCase
{
    ...
    public function testGetImageUri(): void
    {
        ...
        $this->assertEquals(isset($_SERVER["REQUEST_URI"]) ? $_SERVER["REQUEST_URI"] : "", $oGen->getImageUri());
    }
    ...
    {
        $oGen = $this->getMock(\OxidEsales\Eshop\Core\DynamicImageGenerator::class, array("getImageUri"));
        $oGen
            ->method('getImageUri')
    ...
    public function testGetImageInfo(): void
    {
        ...
        $this->assertEquals(array("test4"), $oGen->getImageInfo());
        $this->assertEquals(array("12", "12", "12"), $oGen->getImageInfo());
    }
    ...
    public function testGetNopicImageTarget(): void
    {
        ...
        $this->assertEquals(getShopBasePath() . "/test1/test2/test3/12_12_12/nopic.jpg", $oGen->getNopicImageTarget());
    }

    public function testIsTargetPathValid(): void
    {
        $oGen = $this->getMock(\OxidEsales\Eshop\Core\DynamicImageGenerator::class, array("isValidPath", "createFolders"));
    ...
    {
        $oGen = $this->getMock(\OxidEsales\Eshop\Core\DynamicImageGenerator::class, array("getImageInfo"));
        $oGen
            ->method('getImageInfo')
            ->willReturnOnConsecutiveCalls(
                false,
    ...
    {
        $oGen = $this->getMock(\OxidEsales\Eshop\Core\DynamicImageGenerator::class, array("getImageName"));
        $oGen
            ->method('getImageName')
            ->willReturnOnConsecutiveCalls(
                'test.jpg',
    ...
    public function testGenerateImagePickGenerationMethodFromFileExtension(
        ...
        $oGen->expects($this->any())->method('getImageInfo')->will($this->returnValue(array(100,100,75)));
    ...
    {
        $oGen = $this->getMock(\OxidEsales\Eshop\Core\DynamicImageGenerator::class, array("getImageMasterPath", "getImageName", "getImageTarget", "getNopicImageTarget", "generateImage", "getImageType", "setHeader", "getHeaders"));
