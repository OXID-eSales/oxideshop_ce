...
final class ProductMediaViewTest extends TestCase
{
    public function testGetAttributesReturnsEmptyCollection(): void
    {
        ...
        $this->assertFalse($view->getAttributes()->has(MediaAttribute::ALT));
    }

    public function testGetAttributesReturnsProvidedCollection(): void
    {
        $view = $this->createView(new MediaAttributes([MediaAttribute::ALT => 'my alt text']));
    ...
    {
        $view = $this->createView(new MediaAttributes([MediaAttribute::ALT => 'Red back view']));
    ...
    {
        $view = $this->createView(new MediaAttributes([MediaAttribute::ALT => '']));
    ...
    {
        $view = $this->createView(new MediaAttributes([MediaAttribute::ALT => '  <em>Bold</em> alt  ']));
