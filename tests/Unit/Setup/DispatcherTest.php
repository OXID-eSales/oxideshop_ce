...
class DispatcherTest extends \OxidTestCase
{
    ...
    {
        $oSetup = $this->getMock('OxidEsales\\Eshop\\Setup\\Setup', array("getCurrentStep", "getSteps"));
        ...
        $oDispatcher = $this->getMock('OxidEsales\\Eshop\\Setup\\Dispatcher', array("getInstance"));
