...
class Acceptance_creatingItemsAdminTest extends oxidAdditionalSeleniumFunctions
{
    ...
    public function testCreateCountry()
    {
        ...
        $this->openTab("link=1 DE test Country šÄßüл");
        ...
        $this->assertEquals("on", $this->getValue("editval[oxcountry__oxvatstatus]"));
        ...
        $this->check("document.myedit.elements['editval[oxcountry__oxvatstatus]'][1]");
        $this->clickAndWaitFrame("saveArticle", "list");
        $this->assertEquals("on", $this->getValue("editval[oxcountry__oxactive]"));
        ...
        $this->assertEquals("on", $this->getValue("document.myedit.elements['editval[oxcountry__oxvatstatus]'][1]"));
    ...
    public function testCreateDistributors()
    {
        ...
        $this->selectAndWaitFrame("changelang", "label=Deutsch", "edit");
        $this->openTab("link=1 DE distributor šÄßüл", "editval[oxvendor__oxtitle]");
        $this->assertEquals("1 DE distributor šÄßüл", $this->getValue("editval[oxvendor__oxtitle]"));
        $this->assertEquals("Deutsch", $this->getSelectedLabel("test_editlanguage"));
        $this->frame("list", "changelang");
        $this->selectAndWaitFrame("changelang", "label=English", "edit");
        $this->frame("edit", "test_editlanguage");
        ...
        $this->clickAndWaitFrame("btn.new", "edit", "editval[oxvendor__oxshortdesc]");
        ...
        $this->assertTrue($this->isElementPresent("saveArticle"));
        $this->assertEquals("Save", $this->getValue("saveArticle"));
        $this->clickAndWaitFrame("save", "list");
        $this->assertEquals("Deutsch", $this->getSelectedLabel("test_editlanguage"));
    ...
    public function testCreateManufacturers()
    {
        ...
        $this->clickAndWaitFrame("saveArticle", "list", "test_editlanguage");
    ...
    public function testCreateLanguages()
    {
        ...
        $this->assertFalse($this->isElementPresent("//tr[@id='row.3']"));
        $this->frame("edit");
        $this->clickAndWaitFrame("btn.new", "edit");
        $this->assertEquals("off", $this->getValue("editval[active]"));
        $this->check("editval[active]");
        $this->type("editval[abbr]", "šÄßüл");
        ...
        $this->assertFalse($this->isElementPresent("//tr[@id='row.1']/td[3]/div/a/b"));
        $this->assertFalse($this->isElementPresent("//tr[@id='row.2']/td[3]/div/a/b"));
        //$this->assertFalse($this->isElementPresent("//tr[@id='row.3']/td[3]/div/a/b"));
        $this->assertTrue($this->isElementPresent("//tr[@id='row.3']/td[3]/div/a/b"));
        $this->frame("edit");
        $this->assertEquals("šÄß", $this->getValue("editval[abbr]"));
        ...
        $this->assertEquals("Aß1", $this->getValue("editval[abbr]"));
        ...
        $this->clickAndWaitFrame("saveArticle", "list");
        $this->assertTrue($this->isTextPresent("Error: language with such abbervation already exists!"));
        $this->assertEquals("", $this->getValue("editval[abbr]"));
        $this->assertEquals("", $this->getValue("editval[desc]"));
        $this->frame("list");
        $this->openTab("link=Language_šÄßüл1");
        $this->assertEquals("off", $this->getValue("editval[active]"));
        $this->assertEquals("on", $this->getValue("editval[default]")); //default lang cant be unchecked.
        $this->assertEquals("Aß1", $this->getValue("editval[abbr]"));
        $this->assertEquals("Language_šÄßüл1", $this->getValue("editval[desc]"));
        ...
        $this->assertTrue($this->isElementPresent("//tr[@id='row.1']/td[3]/div/a/b"));
        $this->assertFalse($this->isElementPresent("//tr[@id='row.2']/td[3]/div/a/b"));
        $this->assertFalse($this->isElementPresent("//tr[@id='row.3']/td[3]/div/a/b"));
        //sorting languages
        ...
        $this->assertEquals("Aß1", $this->getText("//tr[@id='row.1']/td[2]/div"));
        ...
        $this->assertTrue($this->isElementPresent("//tr[@id='row.3']/td[@class='listitem4']"));
        //deleting language
        //active language can not be deleted
        $this->assertFalse($this->isElementPresent("del.3"));
        //making en lang as default
        $this->frame("list");
        $this->openTab("link=English");
        $this->check("editval[default]");
        $this->clickAndWait("oLockButton");
        $this->frame("list", "del.3");
        $this->assertTrue($this->isElementPresent("del.3"));
        $this->clickAndConfirm("del.3");
        $this->assertEquals("Deutsch", $this->getText("//tr[@id='row.1']/td[3]"));
        $this->assertEquals("English", $this->getText("//tr[@id='row.2']/td[3]"));
        $this->assertFalse($this->isElementPresent("//tr[@id='row.3']"));
        //trying to delete lang with id = 0. it must be impossible
        $this->clickAndConfirm("del.1");
        $this->assertTrue($this->isTextPresent("Attention: you can't delete main language (with ID = 0)!"));
        $this->assertTrue($this->isElementPresent("link=Deutsch"));
    }
    ...
    public function testCreatePaymentMethod()
    {
            ...
            $this->frame("list");
            $this->selectAndWaitFrame("changelang", "label=Deutsch", "edit");
            $this->openTab("link=3 DE test payment šÄßüл");
            ...
            $this->type("editor_oxpayments__oxlongdesc", "create_delete short desc [EN]_šÄßüл");
            ...
            $this->assertEquals("Copy to", $this->getValue("document.myedit.save[3]"));
            $this->assertEquals("English", $this->getText("test_editlanguage"));
            $this->assertEquals("Deutsch", $this->getText("new_lang"));
            $this->clickAndWaitFrame("document.myedit.save[3]", "list");
            $this->assertEquals("Deutsch", $this->getSelectedLabel("test_editlanguage"));
            ...
            $this->assertEquals("create_delete short desc [EN]_šÄßüл", $this->getValue("editor_oxpayments__oxlongdesc"));
            $this->type("editor_oxpayments__oxlongdesc", "create_delete short desc [DE]");
            $this->clickAndWaitFrame("document.myedit.save[2]", "list");
            ...
            $this->type("editor_oxpayments__oxlongdesc", "create_delete1 short desc [EN]");
            $this->clickAndWaitFrame("document.myedit.save[2]", "list");
            $this->assertEquals("create_delete payment [EN]_šÄßüл", $this->getValue("editval[oxpayments__oxdesc]"));
            ...
            $this->assertEquals("create_delete1 short desc [EN]", $this->getValue("editor_oxpayments__oxlongdesc"));
            $this->assertEquals("", $this->getText("aFields[]"));
            ...
            $this->assertEquals("off", $this->getValue("editval[oxpayments__oxchecked]"));
            $this->assertEquals("1", $this->getValue("editval[oxpayments__oxsort]"));
            $this->assertEquals("create_delete short desc [DE]", $this->getValue("editor_oxpayments__oxlongdesc"));
            $this->assertEquals("field [DE]_šÄßüл", $this->getText("//option[@value='field [DE]_šÄßüл']"));
            ...
            $this->clickAndWait("submitit");
            $this->assertEquals("create_delete payment [EN]_šÄßüл", $this->getText("//tr[@id='row.1']/td[1]"));
            $this->assertFalse($this->isElementPresent("//tr[@id='row.2']/td[1]"));
    }
    ...
    public function testCreateDiscount()
    {
        ...
        $this->selectAndWaitFrame("changelang", "label=Deutsch", "edit");
        $this->assertEquals("Deutsch", $this->getSelectedLabel("changelang"));
        $this->openTab("link=discount for category [DE] šÄßüл");
        ...
        $this->assertEquals("English", $this->getSelectedLabel("test_editlanguage"));
        $this->clickAndWaitFrame("btn.new", "edit");   //button for create new
        $this->type("editval[oxdiscount__oxtitle]", "create_delete discount [EN]_šÄßüл");
        $this->clickAndWaitFrame("save", "list");
        $this->assertTrue($this->isElementPresent("//input[@value='Copy to']"));
        $this->assertEquals("English", $this->getSelectedLabel("test_editlanguage"));
        $this->assertEquals("Deutsch", $this->getSelectedLabel("new_lang"));
        ...
        $this->assertFalse($this->isTextPresent("1000 Test product 0 [EN] šÄßüл"));
        $this->click("//input[@value='Choose product']");
        $this->usePopUp();
        $this->type("_0", "1000");
        $this->keyUp("_0", "0");
        $this->dragAndDrop("//div[@id='container1_c']/table/tbody[2]/tr[1]/td[1]", "container2");
        $this->waitForAjax("1000", "//div[@id='container2_c']/table/tbody[2]/tr[1]/td[1]");
        $this->close();
        $this->selectWindow(null);
        $this->frame("edit");
        $this->clickAndWaitFrame("//input[@value='Save']", "list");
        $this->assertTrue($this->isTextPresent("1000 [DE 4] Test product 0 šÄßüл"));
        ...
        $this->assertEquals("3", $this->getValue("editval[oxdiscount__oxpriceto]"));
        $this->assertEquals("itm", $this->getSelectedLabel("editval[oxdiscount__oxaddsumtype]"));
        $this->assertTrue($this->isTextPresent("1000 Test product 0 [EN] šÄßüл"), "bug from mantis #2366");
        $this->selectAndWait("test_editlanguage", "label=Deutsch");
        $this->assertEquals("create_delete discount [DE]", $this->getValue("editval[oxdiscount__oxtitle]"));
        //testing if other tabs are working
        $this->frame("list");
        ...
        //check if created item can be found
        $this->frame("list");
        $this->assertEquals("English", $this->getSelectedLabel("changelang"));
        $this->type("where[oxdiscount][oxtitle]", "create_delete");
        $this->clickAndWait("submitit");
        $this->assertEquals("create_delete discount [EN]_šÄßüл", $this->getText("//tr[@id='row.1']/td[1]"));
        $this->assertFalse($this->isElementPresent("//tr[@id='row.2']/td[1]"));
    }
    ...
    public function testCreateSHSets()
    {
        ...
        $this->selectAndWaitFrame("changelang", "label=Deutsch", "edit");
        $this->openTab("link=Test S&H set [DE] šÄßüл");
        ...
        $this->clickAndWaitFrame("save", "list", "test_editlanguage");
        ...
        $this->clickAndWait("submitit");
        $this->assertEquals("create_delete SHSet [EN]_šÄßüл", $this->getText("//tr[@id='row.1']/td[1]"));
        $this->assertFalse($this->isElementPresent("//tr[@id='row.2']/td[1]"));
    }
    ...
    public function testCreateSH()
    {
        ...
        $this->selectAndWaitFrame("changelang", "label=Deutsch", "edit");
        $this->assertEquals("Deutsch", $this->getSelectedLabel("changelang"));
        $this->openTab("link=Test delivery category [DE] šÄßüл", "editval[oxdelivery__oxtitle]");
        ...
        $this->assertEquals("English", $this->getSelectedLabel("test_editlanguage"));
        $this->clickAndWaitFrame("btn.new", "edit", "editval[oxdelivery__oxtitle]");   //creating new item
        $this->type("editval[oxdelivery__oxtitle]", "create_delete SH [EN]_šÄßüл");
        $this->clickAndWaitFrame("save", "list", "editval[oxdelivery__oxactive]");
        ...
        $this->check("document.myedit.elements['editval[oxdelivery__oxfixed]'][1]");
        ...
        $this->assertEquals("off", $this->getValue("editval[oxdelivery__oxfixed]"));
        $this->assertEquals("on", $this->getValue("document.myedit.elements['editval[oxdelivery__oxfixed]'][1]"));
        $this->assertEquals("off", $this->getValue("document.myedit.elements['editval[oxdelivery__oxfixed]'][2]"));
        ...
        $this->check("document.myedit.elements['editval[oxdelivery__oxfixed]'][2]");
        ...
        $this->assertEquals("off", $this->getValue("editval[oxdelivery__oxfixed]"));
        $this->assertEquals("off", $this->getValue("document.myedit.elements['editval[oxdelivery__oxfixed]'][1]"));
        $this->assertEquals("on", $this->getValue("document.myedit.elements['editval[oxdelivery__oxfixed]'][2]"));
        ...
        $this->frame("list");
        $this->openTab("link=Users");
        //checking if item can be found after creation
        $this->frame("list");
        $this->type("where[oxdelivery][oxtitle]", "create_delete SH");
        $this->clickAndWait("submitit");
        $this->assertEquals("create_delete SH [EN]_šÄßüл", $this->getText("//tr[@id='row.1']/td[2]"));
        $this->assertFalse($this->isElementPresent("//tr[@id='row.2']/td[2]"));
    }
    ...
    public function testCreateCoupon()
    {
        ...
        $this->clickAndWaitFrame("save", "list", "editval[oxvoucherseries__oxserienr]");
        ...
        $this->assertEquals("on", $this->getValue("editval[oxvoucherseries__oxallowsameseries]"));
        $this->assertEquals("on", $this->getValue("editval[oxvoucherseries__oxallowotherseries]"));
        $this->assertEquals("on", $this->getValue("editval[oxvoucherseries__oxallowuseanother]"));
        $this->assertEquals("off", $this->getValue("document.myedit.elements['editval[oxvoucherseries__oxallowsameseries]'][1]"));
        $this->assertEquals("off", $this->getValue("document.myedit.elements['editval[oxvoucherseries__oxallowotherseries]'][1]"));
        $this->assertEquals("off", $this->getValue("document.myedit.elements['editval[oxvoucherseries__oxallowuseanother]'][1]"));
        ...
        $this->select("editval[oxvoucherseries__oxdiscounttype]", "index=0");
        $this->type("editval[oxvoucherseries__oxminimumvalue]", "110");
        $this->check("document.myedit.elements['editval[oxvoucherseries__oxallowsameseries]'][1]");
        $this->check("document.myedit.elements['editval[oxvoucherseries__oxallowotherseries]'][1]");
        $this->check("document.myedit.elements['editval[oxvoucherseries__oxallowuseanother]'][1]");
        $this->clickAndWaitFrame("save", "list");
        ...
        $this->assertEquals("on", $this->getValue("document.myedit.elements['editval[oxvoucherseries__oxallowsameseries]'][1]"));
        $this->assertEquals("on", $this->getValue("document.myedit.elements['editval[oxvoucherseries__oxallowotherseries]'][1]"));
        $this->assertEquals("on", $this->getValue("document.myedit.elements['editval[oxvoucherseries__oxallowuseanother]'][1]"));
        $this->assertEquals("off", $this->getValue("editval[oxvoucherseries__oxallowsameseries]"));
        $this->assertEquals("off", $this->getValue("editval[oxvoucherseries__oxallowotherseries]"));
        $this->assertEquals("off", $this->getValue("editval[oxvoucherseries__oxallowuseanother]"));
        $this->assertEquals("off", $this->getValue("randomVoucherNr"));
        ...
        $this->click("//input[@name='save' and @value='Generate']");
        sleep(1);
        ...
        $this->checkForErrors();
        $this->click("//input[@name='save' and @value='Export']");
        sleep(1);
        $this->selectFrame("dynexport_do");
        ...
        $this->frame("list");
        $this->assertFalse($this->isElementPresent("link=Export"));
        //checking if item can be found
        $this->type("where[oxvoucherseries][oxserienr]", "create_delete coupon");
        $this->clickAndWait("submitit");
        $this->assertEquals("create_delete coupon1", $this->getText("//tr[@id='row.1']/td[1]"));
        $this->assertFalse($this->isElementPresent("//tr[@id='row.2']/td[1]"));
    ...
    public function testCreateGiftWrapping()
    {
        ...
        $this->openTab("link=1 DE Gift Wrapping šÄßüл");
        ...
        $this->clickAndWait("submitit");
        $this->assertEquals("create_delete gift1 [EN]", $this->getText("//tr[@id='row.1']/td[2]"));
        $this->assertFalse($this->isElementPresent("//tr[@id='row.2']/td[2]"));
    }
    ...
    public function testCreateProductMainExtended()
    {
        ...
        $this->clickAndWait("submitit");
        $this->openTab("link=[DE 4] Test product 0 šÄßüл");
        ...
        $this->assertEquals("English", $this->getSelectedLabel("test_editlanguage"));
        //Product tab
        $this->clickAndWaitFrame("btn.new", "edit", "editval[oxarticles__oxtitle]");
        ...
        $this->assertTrue($this->isElementPresent("editor_oxarticles__oxlongdesc"));
        $this->assertEquals("", $this->getValue("editor_oxarticles__oxlongdesc"));
        $this->type("editor_oxarticles__oxlongdesc", "long desc [EN]_šÄßüл");
        $this->clickAndWaitFrame("saveArticle", "list");
        $this->assertEquals("0", $this->getValue("editval[oxarticles__oxactive]"));
        $this->assertFalse($this->isElementPresent("editval[oxarticles__oxactivefrom]"));
        $this->assertFalse($this->isElementPresent("editval[oxarticles__oxactiveto]"));
        ...
        $this->assertEquals("long desc [EN]_šÄßüл", $this->getValue("editor_oxarticles__oxlongdesc"));
        $this->assertEquals("Save", $this->getValue("saveArticle"));
        $this->assertEquals("Copy Product", $this->getValue("save"));
        $this->assertEquals("Copy to", $this->getValue("document.myedit.save[1]"));
        $this->assertEquals("English", $this->getSelectedLabel("test_editlanguage"));
        $this->assertEquals("Deutsch", $this->getSelectedLabel("new_lang"));
        $this->clickAndWaitFrame("document.myedit.save[1]", "list");
        $this->assertEquals("Deutsch", $this->getSelectedLabel("test_editlanguage"));
        ...
        $this->type("editor_oxarticles__oxlongdesc", "long desc [DE]");
       // $this->clickAndWaitFrame("saveArticle", "list");
        ...
        $this->assertEquals("EAN_šÄßüл", $this->getValue("editval[oxarticles__oxean]"));
        $this->assertEquals("vendor EAN_ßÄ", $this->getValue("editval[oxarticles__oxdistean]"));
        $this->assertEquals("long desc [DE]", $this->getValue("editor_oxarticles__oxlongdesc"));
        $this->selectAndWait("test_editlanguage", "label=English");
        //Extended tab
        $this->frame("list");
        $this->openTab("link=Extended");
        $this->assertFalse($this->isElementPresent("editval[oxarticles__oxurlimg]"), "#289 from Mantis");
        ...
        $this->assertEquals("on", $this->getValue("document.myedit.elements['editval[oxarticles__oxissearch]'][1]"));
        $this->uncheck("document.myedit.elements['editval[oxarticles__oxissearch]'][1]");
        $this->assertEquals("off", $this->getValue("document.myedit.elements['editval[oxarticles__oxnonmaterial]'][1]"));
        $this->check("document.myedit.elements['editval[oxarticles__oxnonmaterial]'][1]");
        $this->assertEquals("off", $this->getValue("document.myedit.elements['editval[oxarticles__oxfreeshipping]'][1]"));
        $this->check("document.myedit.elements['editval[oxarticles__oxfreeshipping]'][1]");
        $this->assertEquals("off", $this->getValue("editval[oxarticles__oxblfixedprice]"));
        ...
        $this->assertFalse($this->isElementPresent("editval[oxarticles__oxbundleid]"));
        $this->assertTrue($this->isElementPresent("//input[@value='Assign Products']"));
        ...
        $this->assertEquals("off", $this->getValue("document.myedit.elements['editval[oxarticles__oxissearch]'][1]"));
        $this->assertEquals("on", $this->getValue("document.myedit.elements['editval[oxarticles__oxnonmaterial]'][1]"));
        $this->assertEquals("on", $this->getValue("document.myedit.elements['editval[oxarticles__oxfreeshipping]'][1]"));
        ...
        $this->frame("list");
        $this->openTab("link=Pictures");
        $this->frame("list");
        $this->openTab("link=Review");
        $this->frame("list");
        $this->openTab("link=Statistics");
        $this->frame("list");
        $this->openTab("link=SEO");
    }
    ...
    public function testCreateProductCopy()
    {
        ...
        $this->clickAndWaitFrame("saveArticle", "list", "document.myedit.save[1]");
        $this->clickAndWaitFrame("document.myedit.save[1]", "list", "saveArticle");
        $this->check("editval[oxarticles__oxactive]");
        $this->type("editval[oxarticles__oxtitle]", "create_delete product [DE]");
        $this->type("editval[oxarticles__oxshortdesc]", "create_delete short desc [DE]");
        $this->type("editval[oxarticles__oxsearchkeys]", "search [DE]");
        ...
        $this->openTab("link=Extended", "editval[oxarticles__oxweight]");
        $this->type("editval[oxarticles__oxweight]", "1");
        $this->type("editval[oxarticles__oxlength]", "2");
        $this->type("editval[oxarticles__oxwidth]", "3");
        $this->type("editval[oxarticles__oxheight]", "4");
        ...
        $this->frame("list");
        $this->openTab("link=SEO");
        //checkin if elements can be found
        $this->frame("list");
    ...
    public function testCreateProductStockPrices()
    {
        ...
        $this->frame("edit");
        //Product tab
        $this->clickAndWaitFrame("btn.new", "edit",null,3);
        $this->type("editval[oxarticles__oxtitle]", "create_delete product");
        $this->type("editval[oxarticles__oxartnum]", "10000");
        $this->type("editval[oxarticles__oxprice]", "5.9");
        $this->clickAndWaitFrame("saveArticle", "list");
        $this->clickAndWaitFrame("document.myedit.save[1]", "list", null, 3);
        $this->selectAndWait("test_editlanguage", "label=English");
    ...
    public function testCreateProductVariants()
    {
        ...
        $this->assertEquals("English", $this->getSelectedLabel("changelang"));
        $this->openTab("link=Variants");
        $this->selectAndWait("document.myedit.editlanguage", "label=English");
        $this->assertEquals("English", $this->getSelectedLabel("document.myedit.editlanguage"));
        ...
        $this->selectAndWait("document.myedit.editlanguage", "label=Deutsch");
        ...
        //deleting variant
        $this->assertTrue($this->isElementPresent("//input[@value='var 1 [EN]_šÄßüл']"));
        $this->clickAndConfirm("//tr[@id='test_variant.1']/td[9]/a", "//input[@value='New Variant']");
        $this->assertFalse($this->isElementPresent("//input[@value='var 1 [EN]_šÄßüл']"));
    }
    ...
    public function testCreateProductMedia()
    {
        ...
        $this->clickAndWait("save");
        $this->assertTrue($this->isTextPresent("Please enter description"));
        ...
        $this->type("mediaUrl", "http://www.youtube.com/watch?v=OPqV4ipyMsg");
        $this->clickAndWait("save");
        $this->assertTrue($this->isElementPresent("//fieldset[@title='Media URLs']/table/tbody/tr[1]/td[3]/input"));
        $this->assertTrue($this->isElementPresent("//fieldset[@title='Media URLs']/table/tbody/tr[2]/td[3]/input"));
        $this->assertEquals("media file [EN]_šÄßüл", $this->getValue("//fieldset[@title='Media URLs']/table/tbody/tr[1]/td[3]/input"));
        $this->assertEquals("second media file", $this->getValue("//fieldset[@title='Media URLs']/table/tbody/tr[2]/td[3]/input"));
        $this->clickAndConfirm("//fieldset[@title='Media URLs']/table/tbody/tr[2]/td[2]/a", "save");
        $this->assertEquals("media file [EN]_šÄßüл", $this->getValue("//fieldset[@title='Media URLs']/table/tbody/tr[1]/td[3]/input"));
        $this->assertFalse($this->isElementPresent("//fieldset[@title='Media URLs']/table/tbody/tr[2]/td[3]/input"));
        $this->clickAndConfirm("//fieldset[@title='Media URLs']/table/tbody/tr[1]/td[2]/a", "save");
        $this->assertFalse($this->isElementPresent("//fieldset[@title='Media URLs']/table/tbody/tr[1]/td[3]/input"));
    }
    ...
    public function testCreateProductMultidimensionalVariants()
    {
        ...
        $this->clickAndWait("//input[@value='Save Selection']");
        $this->assertFalse($this->isElementPresent("//tr[@id='test_variant.1']"));
        ...
        $this->selectAndWait("//select[@name='editlanguage']", "label=English");
        ...
        $this->assertTrue($this->isElementPresent("test_variant.15"));
    ...
    public function testCreateAttribute()
    {
        ...
        $this->clickAndWait("submitit");
        $this->openTab("link=Test attribute 1 [DE] šÄßüл");
    ...
    public function testCreateCategory()
    {
        ...
        $this->assertTrue($this->isTextPresent("Test category 0 [EN] šÄßüл"), "Bug #597 from Mantis");
        ...
        $this->assertEquals("on", $this->getValue("editval[oxcategories__oxdefsortmode]"));
        ...
        $this->check("document.myedit.elements['editval[oxcategories__oxdefsortmode]'][1]");
        ...
        $this->assertEquals("on", $this->getValue("document.myedit.elements['editval[oxcategories__oxdefsortmode]'][1]"));
        ...
        //testing if other tabs are working
        $this->frame("list");
        $this->openTab("link=Text");
        $this->assertEquals("English", $this->getSelectedLabel("//select[@name='catlang']"));
        $this->assertEquals("", $this->getValue("editor_oxcategories__oxlongdesc"));
        $this->type("editor_oxcategories__oxlongdesc", "long desc [EN]_šÄßüл");
        $this->clickAndWait("save");
        $this->assertEquals("long desc [EN]_šÄßüл", $this->getValue("editor_oxcategories__oxlongdesc"));
        $this->selectAndWait("//select[@name='catlang']", "label=Deutsch");
        $this->assertEquals("", $this->getValue("editor_oxcategories__oxlongdesc"));
        $this->type("editor_oxcategories__oxlongdesc", "long desc [DE]");
        $this->clickAndWait("save");
        $this->assertEquals("long desc [DE]", $this->getValue("editor_oxcategories__oxlongdesc"));
        $this->selectAndWait("//select[@name='catlang']", "label=English");
        $this->assertEquals("long desc [EN]_šÄßüл", $this->getValue("editor_oxcategories__oxlongdesc"));
        $this->selectAndWait("//select[@name='catlang']", "label=Deutsch");
        $this->assertEquals("long desc [DE]", $this->getValue("editor_oxcategories__oxlongdesc"));
        $this->frame("list");
        $this->openTab("link=Picture");
        $this->frame("list");
        $this->openTab("link=Sorting");
        $this->frame("list");
        $this->openTab("link=SEO");
        //checking if item can be found
        $this->frame("list");
    ...
    public function testCreateSelectionList()
    {
        ...
        $this->selectAndWaitFrame("changelang", "label=Deutsch", "edit");
        $this->openTab("link=test selection list [DE] šÄßüл");
        ...
        $this->assertTrue($this->isTextPresent("Sorting out of bounds"));
        $this->addSelection("aFields", "label=1 - field [EN]_šÄßüл,5%");
        $this->type("EditAddName", "field1 [EN]");
    ...
    public function testCreateUserExtendedInfo()
    {
        $sql = "INSERT INTO `oxuser` (`OXID`, `OXACTIVE`, `OXRIGHTS`, `OXSHOPID`, `OXUSERNAME`, `OXPASSWORD`, `OXPASSSALT`,
                                      ...
                                      `OXPRIVFON`, `OXMOBFON`, `OXBIRTHDATE`, `OXURL`, `OXDISABLEAUTOGRP`, `OXUPDATEKEY`, `OXUPDATEEXP`)
                              VALUES ('kdiruuc', 0, 'malladmin', 'oxbaseshop', 'birute00@nfq.lt', '89bb88b81f9b3669fc4c44e082dd9927', '3032396331663033316535343361356231363666653666316533376235353830',
        ...
        $this->executeSql( $sql );
        $this->loginAdmin("Administer Users", "Users");
        $this->clickAndWaitFrame("link=birute00@nfq.lt", "edit");
        // Extended tab
        $this->openTab("link=Extended");
        $this->assertEquals("Mr Name1 Surname1 company1 street1 11 BE 30001 City11 additional info1 Belgium 1112223331", $this->clearString($this->getText("test_userAddress")));
        $this->type("editval[oxuser__oxprivfon]", "555444555");
        $this->type("editval[oxuser__oxmobfon]", "666555666");
        $this->assertEquals("off", $this->getValue("document.myedit.editnews[1]"));
        $this->check("document.myedit.editnews[1]");
        $this->assertEquals("off", $this->getValue("document.myedit.emailfailed[1]"));
        $this->check("document.myedit.emailfailed[1]");
        ...
        $this->assertEquals("off", $this->getValue("document.myedit.elements['editval[oxuser__oxdisableautogrp]'][1]"));
        $this->check("document.myedit.elements['editval[oxuser__oxdisableautogrp]'][1]");
        $this->clickAndWait("save");
        ...
        $this->assertEquals("on", $this->getValue("document.myedit.editnews[1]"));
        $this->assertEquals("on", $this->getValue("document.myedit.emailfailed[1]"));
        ...
        $this->assertEquals("on", $this->getValue("document.myedit.elements['editval[oxuser__oxdisableautogrp]'][1]"));
        $this->uncheck("document.myedit.editnews[1]");
        $this->uncheck("document.myedit.emailfailed[1]");
        $this->uncheck("document.myedit.elements['editval[oxuser__oxdisableautogrp]'][1]");
    ...
    public function testCreateUserAddresses()
    {
        $sql = "INSERT INTO `oxuser` (`OXID`, `OXACTIVE`, `OXRIGHTS`, `OXSHOPID`, `OXUSERNAME`, `OXPASSWORD`, `OXPASSSALT`,
                              ...
                              VALUES ('kdiruuc', 0, 'malladmin', 'oxbaseshop', 'birute00@nfq.lt', '89bb88b81f9b3669fc4c44e082dd9927', '3032396331663033316535343361356231363666653666316533376235353830',
                                      121, '111222', 'company1', 'Name1', 'Surname1', 'street1', '11', 'additional info1', 'City11',
                                       'a7c40f632e04633c9.47194042', 'BE', '30001', '1112223331', '2223334441', 'MR', 1000, '2010-02-05 10:22:37', '2010-02-05 10:22:48',
                                      '5554445551', '6665556661', '1979-01-03', 'http://www.url1.com', 0, '', 0);";
         $this->executeSql( $sql );
        $this->loginAdmin("Administer Users", "Users");
        $this->clickAndWaitFrame("link=birute00@nfq.lt", "edit");
        //Addresses tab
    ...
    public function testCreateUserGroups()
    {
        ...
        $this->clickAndWait("submitit");
        $this->assertEquals("create_delete group_šÄßüл", $this->getText("//tr[@id='row.1']/td[1]"));
        $this->selectAndWait("changelang", "label=Deutsch");
        $this->assertEquals("create_delete group1", $this->getText("//tr[@id='row.1']/td[1]"));
        $this->assertFalse($this->isElementPresent("//tr[@id='row.2']/td[1]"));
    }
    ...
    public function testCreateNews()
    {
        ...
        $this->selectAndWaitFrame("changelang", "label=Deutsch", "list");
        $this->clickAndWait("link=Title");
        $this->openTab("link=1 [DE] Test news šÄßüл");
        ...
        $this->assertEquals("", $this->getValue("editor_oxnews__oxlongdesc"));
        $this->type("editor_oxnews__oxlongdesc", "news desc [EN]_šÄßüл");
        $this->clickAndWait("save");
        $this->assertEquals("news desc [EN]_šÄßüл", $this->getValue("editor_oxnews__oxlongdesc"));
        $this->selectAndWait("newslang", "label=Deutsch");
        $this->assertEquals("", $this->getValue("editor_oxnews__oxlongdesc"));
        $this->type("editor_oxnews__oxlongdesc", "news desc [DE]");
        $this->clickAndWait("save");
        $this->assertEquals("news desc [DE]", $this->getValue("editor_oxnews__oxlongdesc"));
        $this->selectAndWait("newslang", "label=English");
        $this->assertEquals("news desc [EN]_šÄßüл", $this->getValue("editor_oxnews__oxlongdesc"));
        $this->selectAndWait("newslang", "label=Deutsch");
        $this->assertEquals("news desc [DE]", $this->getValue("editor_oxnews__oxlongdesc"));
        //checking if created item can be found
        ...
        $this->clickAndWait("submitit");
        $this->assertEquals("create_delete news [EN]_šÄßüл", $this->getText("//tr[@id='row.1']/td[2]"));
        $this->assertFalse($this->isElementPresent("//tr[@id='row.2']/td[2]"));
    }
    ...
    public function testCreateNewsletter()
    {
        ...
        $this->clickAndWait("submitit");
        $this->assertFalse($this->isElementPresent("link=title"));
        $this->frame("edit");
        $this->clickAndWaitFrame("btn.new", "edit");
        $this->assertEquals("", $this->getValue("editval[oxnewsletter__oxtitle]"));
        $this->assertEquals("", $this->getValue("editor_oxnewsletter__oxtemplate"));
        $this->type("editval[oxnewsletter__oxtitle]", "title_šÄßüл");
        $this->type("editor_oxnewsletter__oxtemplate", "sample text_šÄßüл");
        $this->clickAndWaitFrame("save", "list");
        $this->assertEquals("title_šÄßüл", $this->getValue("editval[oxnewsletter__oxtitle]"));
        $this->assertEquals("sample text_šÄßüл", $this->getValue("editor_oxnewsletter__oxtemplate"));
        $this->frame("list");
        $this->assertTrue($this->isElementPresent("link=title_šÄßüл"));
    }
    ...
    public function testCreateLinks()
    {
        ...
        $this->openTab("link=http://www.1google.com");
        $this->assertEquals("Deutsch", $this->getSelectedLabel("test_editlanguage"));
        $this->frame("list");
        $this->selectAndWaitFrame("changelang", "label=English", "edit");
        $this->frame("edit");
        ...
        $this->assertEquals("", $this->getValue("editor_oxlinks__oxurldesc"));
        $this->type("editor_oxlinks__oxurldesc", "link desc [EN]_šÄßüл");
        $this->clickAndWaitFrame("save", "list");
        ...
        $this->assertEquals("link desc [EN]_šÄßüл", $this->getValue("editor_oxlinks__oxurldesc"));
        $this->assertEquals("Copy to", $this->getValue("save"));
        $this->assertEquals("English", $this->getSelectedLabel("test_editlanguage"));
        $this->assertEquals("Deutsch", $this->getText("new_lang"));
        $this->clickAndWaitFrame("save", "list");
        ...
        $this->assertEquals("link desc [EN]_šÄßüл", $this->getValue("editor_oxlinks__oxurldesc"));
        $this->type("editor_oxlinks__oxurldesc", "link desc [DE]");
        $this->clickAndWaitFrame("save", "list");
        $this->assertEquals("link desc [DE]", $this->getValue("editor_oxlinks__oxurldesc"));
        ...
        $this->clickAndWait("submitit");
        $this->assertEquals("http://www.create_delete1.com", $this->getText("//tr[@id='row.1']/td[2]"));
        $this->assertFalse($this->isElementPresent("//tr[@id='row.2']/td[2]"));
    }
    ...
    public function testCreateGuestbook()
    {
        ...
        $this->openTab("link=Demo guestbook entry [DE] šÄßüл");
        ...
        $this->clickAndWaitFrame("save", "list");
        $this->frame("list", "link=ddd_šÄßüл");
        $this->assertTrue($this->isElementPresent("link=ddd_šÄßüл"));
        $this->frame("edit");
    ...
    public function testCreateCms()
    {
        ...
        $this->openTab("link=[last]testcontent");
        $this->assertEquals("1 [DE] content šÄßüл", $this->getValue("editval[oxcontents__oxtitle]"));
        $this->assertEquals("Deutsch", $this->getSelectedLabel("test_editlanguage"));
        $this->frame("list");
        $this->selectAndWaitFrame("changelang", "label=English", "list");
        $this->frame("edit");
        ...
        $this->assertEquals("off", $this->getValue("oxtype0"));
        $this->assertEquals("off", $this->getValue("oxtype1"));
        $this->assertEquals("off", $this->getValue("oxtype2"));
        $this->assertEquals("off", $this->getValue("oxtype3"));
        $this->check("oxtype0");
        $this->assertEquals("None", $this->getSelectedLabel("editval[oxcontents__oxfolder]"));
        $this->assertEquals("", $this->getValue("editor_oxcontents__oxcontent"));
        $this->type("editor_oxcontents__oxcontent", "cms page [EN] šÄßüл");
        ...
        $this->assertEquals("on", $this->getValue("oxtype0"));
        $this->clickAndWaitFrame("save", "list");
        $this->type("editval[oxcontents__oxtitle]", "create_delete cms [DE]");
        $this->assertEquals("cms page [EN] šÄßüл", $this->getValue("editor_oxcontents__oxcontent"));
        $this->type("editor_oxcontents__oxcontent", "cms page [DE]");
        $this->check("oxtype1");
        $this->clickAndWaitFrame("saveContent", "list");
        $this->assertEquals("on", $this->getValue("editval[oxcontents__oxactive]"));
        $this->assertEquals("create_delete cms [DE]", $this->getValue("editval[oxcontents__oxtitle]"));
        $this->assertEquals("create_delete_ident", $this->getValue("editval[oxcontents__oxloadid]"));
        $this->assertEquals("on", $this->getValue("oxtype1"));
        $this->assertEquals("off", $this->getValue("oxtype0"));
        $this->assertEquals("off", $this->getValue("oxtype2"));
        $this->assertEquals("off", $this->getValue("oxtype3"));
        $this->assertEquals("cms page [DE]", $this->getValue("editor_oxcontents__oxcontent"));
        ...
        $this->assertEquals("E-mails", $this->getSelectedLabel("editval[oxcontents__oxfolder]"));
        $this->assertEquals("on", $this->getValue("oxtype2"));
        $this->assertEquals("1 [EN] category šÄßüл", $this->getSelectedLabel("editval[oxcontents__oxcatid]"));
        $this->assertEquals("cms page [EN] šÄßüл", $this->getValue("editor_oxcontents__oxcontent"));
        ...
        $this->assertEquals("create_delete_ident", $this->getValue("editval[oxcontents__oxloadid]"));
        $this->assertEquals("on", $this->getValue("oxtype3"));
        $this->assertTrue($this->isElementPresent("//tr[@id='manuell']/td[2]/input"));
        ...
        $this->clickAndWait("submitit");
        $this->assertEquals("create_delete_ident", $this->getText("//tr[@id='row.1']/td[2]"));
        $this->assertFalse($this->isElementPresent("//tr[@id='row.2']/td[2]"));
    }
    ...
    public function testCreatePromotions()
    {
        ...
        $this->clickAndWait("btn.new", "editval[oxactions__oxtitle]");
        ...
        $this->clickAndWait("save", "test_editlanguage");
        $this->assertEquals("Deutsch", $this->getSelectedLabel("test_editlanguage"));
        ...
        $this->clickAndWait("link=A");
        $this->assertTrue($this->isElementPresent("nav.page.2"));
        $this->assertEquals("2", $this->getText("nav.page.2"));
        $this->clickAndWait("nav.page.2");
        $this->assertEquals("create_delete promotion", $this->getText("//tr[@id='row.1']/td[2]"));
        $this->clickAndConfirm("del.1");
        $this->assertFalse($this->isElementPresent("nav.page.2"));
        $this->clickAndWait("link=Name");
        $this->assertEquals("Bargain", $this->getText("//tr[@id='row.1']/td[2]"));
    }
    ...
    public function testCreatePromotionsAction()
    {
        ...
        $this->assertEquals("2", $this->getText("nav.page.2"));
        $this->clickAndWait("nav.page.2");
        $this->assertEquals("create_delete action", $this->getText("//tr[@id='row.1']/td[2]"));
        $this->clickAndConfirm("del.1");
        $this->assertFalse($this->isElementPresent("nav.page.2"));
        $this->clickAndWait("link=Name");
        $this->assertEquals("Bargain", $this->getText("//tr[@id='row.1']/td[2]"));
