...
REPLACE INTO `oxobject2payment` (`OXID`, `OXPAYMENTID`, `OXOBJECTID`, `OXTYPE`) VALUES ('f0d4f35c10ababfc57a22aeda37f30a3', 'oxidpaypal', '8f241f11096877ac0.98748826', 'oxcountry');

#assigne US to Standard shppingmethode
REPLACE INTO `oxobject2delivery` (`OXID`,        		 `OXDELIVERYID`, 	`OXOBJECTID`,                 `OXTYPE`) VALUES ('157ff126b33b2b82b575d73acd3b4b43', 'oxidstandard',     '8f241f11096877ac0.98748826', 'oxdelset');
