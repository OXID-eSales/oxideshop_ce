...
class Integration_Modules_ModuleActivationFirstTest extends BaseModuleTestCase
{
    ...
    public function testModuleActivationInMainShopDidNotActivatedInSubShop( $aInstallModules, $sModule, $aResultToAsserts )
    {
        ...
        $this->_activateModuleOnShop( $sModule, $oModule, 1 );
        $this->_activateModuleOnShop( $sModule, $oModule, 2 );
        $this->_deactivateModuleOnShop( $sModule, $oModule, 1 );
    ...
    /**
     * Activates module on on selected shop.
     *
     * @param $sModule Module Id
     * @param $oModule Module object
     * @param $iShopId Shop Id
     */
    private function _activateModuleOnShop( $sModule, $oModule, $iShopId )
    {
    ...
    /**
     * Deactivates module on on selected shop.
     *
     * @param $sModule Module Id
     * @param $oModule Module object
     * @param $iShopId Shop Id
     */
    private function _deactivateModuleOnShop( $sModule, $oModule, $iShopId )
    {
        $this->_getConfig()->setShopId( $iShopId );
        $oModule->load( $sModule );
        $oModule->deactivate();
