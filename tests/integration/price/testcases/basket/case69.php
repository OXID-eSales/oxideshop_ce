 ...
 * Vouchers: -
 * Trusted Shop:
 *  1. "TS080501_500_30_EUR"  "netto" => "0.98", "amount" => "500" ,
 * Wrapping: -;
 * Gift cart:  -;
 ...
 *  3. TS -
 * Short description: 
 * Neto-Neto mode. Additiona products Neto-Neto. Testing trusted shop-> If price is 10€ < 500€, then is used trusted shop with parameters:
 * "netto" => "0.98", "amount" => "500" ,. 
 */
$aData = array(
    'articles' => array (
        0 => array (
