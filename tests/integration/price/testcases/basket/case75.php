 ...
 *  3. TS -
 * Short description: 
 * Neto-Neto mode. Additiona products Neto-Neto. Testing trusted shop . If product total price is >2500€, then is used trusted shop with parameters:
 * "netto" => "4.12", "amount" => "2500" ,. 
 */
$aData = array(
    'articles' => array (
        0 => array (
