 ...
 * @version   SVN: $Id: articleattributeajaxTest.php 31986 2010-12-17 14:03:45Z sarunas $
 */
...
class Unit_Admin_ArticleAttributeAjaxTest extends OxidTestCase
{
    ...
    public function testSaveAttributeValue()
    {
        ...
        modConfig::setParameter( "oxid", $sOxid );
        modConfig::setParameter( "attr_oxid", $sAttrOxid );
        modConfig::setParameter( "attr_value", $sAttrValue );
