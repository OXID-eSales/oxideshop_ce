...
class Unit_Core_oxemailTest extends OxidTestCase
{
    ...
    public function testSendRegisterConfirmEmail()
    {
        ...
        $oEmail = $this->getMailerMock(array("sendRegisterEmail"));
    ...
    public function testIncludeImagesErrorTestCase()
    {
        ...
        $oEmail = $this->getMailerMock(array('getBody', 'addEmbeddedImage', 'setBody'));
    ...
    {
        $oEmail = $this->getMailerMock(array("_sendMail"));
    ...
    {
        $oEmail = $this->getMailerMock(array("_sendMail", "_sendMailErrorMsg", "getMailer"));
        $oEmail->expects($this->exactly(2))->method('_sendMail')->will($this->returnValue(false));
    ...
    public function testSetSmtp()
    {
        ...
        $oEmail = $this->getMailerMock(array('_isValidSmtpHost'));
    ...
    {
        $oEmail = $this->getMailerMock(array("send", "_getShop"));
    ...
    public function testSendBackupMailWithAttachment()
    {
        ...
        $email = $this->getMailerMock(array("_sendMail", "_getShop"));
    ...
    {
        $oEmail = $this->getMailerMock(array("_getShop"));
        $oEmail->expects($this->any())->method('_getShop')->will($this->returnValue($this->_oShop));
    ...
    {
        $oEmail = $this->getMailerMock(array("getRecipient", "getMailer", "_sendMail", "_sendMailErrorMsg"));
    ...
    {
        // no smtp connect
        $oEmail = $this->getMailerMock(array('_isValidSmtpHost', '_getShop'));
    ...
    */
    ...
    {
        $oEmail = $this->getMailerMock(array('set'));
    ...
    public function testSendOrderEmailToOwnerCorrectSenderReceiver()
    {
        ...
        $oEmail = $this->getMailerMock(array("_sendMail", "_getSmarty"));
        $oEmail->expects($this->once())->method("_sendMail")->will($this->returnValue(true));
    ...
    public function testSendSuggestMailCorrectSender()
    {
        ...
        $oEmail = $this->getMailerMock(array("send", "_getSmarty"));
