...
class Unit_Core_oxImexTest extends OxidTestCase
{
    ...
    public function test_exportLexwareArticles()
    {
        ...
        // check header
        $this->assertEquals('"Artikelnummer";"Bezeichnung";"Einheit";"Gewicht";"Matchcode";"Preis pro Anzahl";'
        ...
        foreach ($aContents as $content) {
            if (strpos($content, '2000;Wanduhr ROBOT') === 0){
                    $this->assertEquals('2000;Wanduhr ROBOT ;Stueck;0;2000;1,000;;;;;;;29.00;;;;;;;;;;;;;;0.00;;;;;;;;;'
