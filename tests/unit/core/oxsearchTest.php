...
class Unit_Core_oxsearchTest extends OxidTestCase
{
    ...
    public function testGetSearchSelectPassingAllWhatIsNeeded()
    {
        ...
        $sFix = "select `$sArticleTable`.`oxid` from $sO2Cat as oxobject2category, $sArticleTable where
                 ...
                 and ( (  $sArticleTable.oxtitle like '%�%' or $sArticleTable.oxtitle like '%&uuml;%' or
                 $sArticleTable.oxshortdesc like '%�%' or $sArticleTable.oxshortdesc like '%&uuml;%' or
                 $sArticleTable.oxsearchkeys like '%�%' or $sArticleTable.oxsearchkeys like '%&uuml;%' or
                 $sArticleTable.oxartnum like '%�%' or $sArticleTable.oxartnum like '%&uuml;%' )
        ...
        $oSearch = new oxsearch();
        $sQ = $oSearch->UNITgetSearchSelect('� a', $sIDCat, $sIDVend, $sIDMan, "$sArticleTable.oxtitle");
