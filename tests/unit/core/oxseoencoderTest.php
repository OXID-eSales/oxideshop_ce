...
class Unit_Core_oxSeoEncoderTest extends OxidTestCase
{
    ...
    public function testIfMetaDataIsEncodedCorrectlyWhileSaving()
    {
        ...
        $sInKeywords = "Laufr�der '\"";
        $sInDescription = "Laufr�der '\"";

        $sOutKeywords = "Laufr�der &#039;&quot;";
        $sOutDescription = "Laufr�der &#039;&quot;";
    ...
    {
        $oEncoder = new modSeoEncoder();
        $sTitleIn = '///AA keyword1 keyword2 �  � � � � � �' . str_repeat(' a', 300);
        $oEncoder->setSeparator();
    ...
    {
        $sString = '&quot;&lt;Flaschen�ffner&#039;&amp;quot;';
        $sEncodedString = "\"<Flaschenoeffner'";
        $sPartEncodedString = '"<Flaschen�ffner\'';
