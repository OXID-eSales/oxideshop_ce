...
class Unit_Core_oxstrMbTest extends OxidTestCase
{
    ...
    {
        $this->assertEquals($this->_2Utf("Hö hö."),
                            $this->_oSubj->substr($this->_2Utf($this->_sStrHaystack), 33));
    }

    public function testSubstr3Params()
    {
        $this->assertEquals($this->_2Utf("Design Bau - auf zu neuen Höhe"),
    ...
    {
        $this->assertEquals($this->_2Utf("Höhen. Hö hö."),
    ...
    public function testWordwrapMimicsPhpInternalWW()
    {
        ...
        $this->assertEquals(wordwrap('aaa aaa', 2, "\n", false),
                            $this->_oSubj->wordwrap( 'aaa aaa', 2, "\n", false));
        $this->assertEquals(wordwrap('aaa aaa', 2, "\n", true),
                            $this->_oSubj->wordwrap( 'aaa aaa', 2, "\n", true));

        $this->assertEquals(wordwrap('aaa aaa a', 5, "\n", false),
                            $this->_oSubj->wordwrap( 'aaa aaa a', 5, "\n", false));
        $this->assertEquals(wordwrap('aaa aaa', 5, "\n", true),
        ...
        // very important:
        $this->assertEquals(wordwrap("laba diena, kjabsdjhb hb bhb bhbhh\n as esu sarunas tekste.\n o chia buvo new line. arvydas.\naaa    aaa", 10, "\n", true),
