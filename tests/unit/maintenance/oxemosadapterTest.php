...
class Unit_Maintenance_oxemosadapterTest extends OxidTestCase
{
    ...
    public function testConvProd2EmosItem()
    {
        ...
        $oProduct->oxarticles__oxtitle = new oxField('ox�title');
        $oProduct->oxarticles__oxvarselect = new oxField('ox�varselect');

        $sContent = "SHOP/ox�title";
    ...
    public function testPrepareProductTitle()
    {
        ...
        $sContent = "ox�title ox�varselect";
        $sCharset = oxRegistry::getLang()->translateString('charset');
    ...
    {
        $aCat1 = array('title' => '1�', 'link' => 'http://one');
        $aCat2 = array('title' => '2�', 'link' => 'http://two');
        $aCat3 = array('title' => '3�', 'link' => 'http://three');
