<h1 class="page-header">Test module for controller routing other template - [{$the_module_message}]</h1>

<form action="[{$oViewConf->getSelfActionLink()}]" name="MyModuleControllerAction" method="post" role="form">
    <div>
        [{$oViewConf->getHiddenSid()}]
        <input type="hidden" name="cl" value="test_module_controller_routing_ns_MyOtherModuleController">
